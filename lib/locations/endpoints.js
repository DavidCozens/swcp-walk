...
// so both landings are the ends of the ferry way, and so is the Dart, where
// stage 41 starts at Kingswear, and the Exe, where stage 43 ends at Starcross.
...
export default [
  ...
  {
    // The Kingswear end of OSM ferry way 151746723, the Lower Ferry (node
    // 11654531), where section 41 picks the path up.
    slug: "kingswear",
    name: "Kingswear",
    kind: "endpoint",
    lat: 50.34838, lon: -3.57317,
    notes: "The Lower Ferry slip at Kingswear, across the Dart from Dartmouth; the passenger ferry lands at the pontoon 60 m north, by the station and the steam trains to Paignton",
  },
  {
    slug: "brixham",
    name: "Brixham",
  ...
  {
    // The Starcross end of OSM ferry ways 1018527171 and 12654807, at the
    // pier by the station.
    slug: "starcross",
    name: "Starcross",
    kind: "endpoint",
    lat: 50.62686, lon: -3.44538,
    notes: "The ferry pier at Starcross, by the station and the old atmospheric railway pumping house; Exmouth is across the Exe and about 25 km round by Exeter",
  },
  {
    slug: "exmouth",
    name: "Exmouth",
