...
export default [
  ...
  // Section 41.
  {
    slug: "ship-inn-kingswear",
    name: "The Ship Inn",
    kind: "stay",
    food: { type: "pub" },
    // OSM node 7861212085, "The Ship Inn". The TQ6 0AG postcode centroid is
    // 55 m north-west.
    lat: 50.34857, lon: -3.57225,
    address: "The Ship Inn, Higher Street, Kingswear, Devon, TQ6 0AG",
    phone: "01803 467120",
    url: "https://www.theshipinnkingswear.co.uk/rooms/",
    // The owner's own rooms page. It publishes no tariff and no email; rooms
    // book through a "Reserve a Room" form.
    notes: "Fifteenth-century pub in Higher Street, a minute up from the Lower Ferry slip where the walk starts, looking across the Dart to Dartmouth. Three letting rooms under the name Dart Bank, contemporary, with modern en-suites. Leo and Hannah run it. The Grill Room restaurant is on the first floor with river views, seafood and steaks, and there is a beer terrace over the water; live music and sea shanty nights. No parking of its own — Kingswear's streets are steep and narrow, and the village car park is on the quay",
    verified: "2026-09-16",
    stay: {
      type: "inn",
      dogs: true,
      dogs_note: "\"Children and well-behaved dogs are welcome. Booking always advisable.\" No charge published",
      season: null,
      price_per_night: null,
      price_note: "not published; rooms are booked through the owner's form",
    },
  },
  {
    slug: "brownstone-car-park",
    name: "Brownstone car park",
    kind: "stay",
    // Centre of OSM way 30246710, the National Trust car park at the end of
    // Brownstone Road. The TQ6 0EH postcode the Trust gives for a sat nav is a
    // centroid 460 m south-west, covering the lane.
    lat: 50.34866, lon: -3.54118,
    address: "Brownstone, Kingswear, TQ6 0EH",
    url: "https://www.nationaltrust.org.uk/visit/devon/dartmouth-and-kingswear-countryside/car-parks-in-dartmouth-and-kingswear-countryside",
    // Charges and the overnight rule from the Trust's own car parks page.
    notes: "National Trust car park above Froward Point, where the path leaves the lanes for the cliff — a level, accessible track runs down to the Day Mark and the Brownstone Battery. Not a place to sleep: \"We don't allow overnight parking due to the impact on nature and wildlife, staff resource and visitors.\" Free to members, £1.20 an hour, £3.60 up to three hours or £4.80 all day otherwise; cash, or the JustPark app. No height barrier, but the lane in is single-track and tight for anything long. The Trust's other car parks on this stretch — Coleton Camp, Scabbacombe and Mansands — charge the same and carry the same rule",
    verified: "2026-09-16",
    stay: {
      type: "park4night",
      dogs: null,
      season: "all-year",
      price_per_night: null,
      price_note: "no night rate: overnight parking is not allowed. All day £4.80, free to National Trust members",
      hookup: false,
    },
  },
  {
    slug: "coleton-camp-car-park",
    name: "Coleton Camp car park",
    kind: "stay",
    // Centre of OSM way 30246705, "National Trust - Coleton Camp", 25 spaces.
    // The Trust gives TQ6 0EQ for a sat nav; that centroid is 420 m south, at
    // the Coleton Fishacre house car park.
    lat: 50.35081, lon: -3.53407,
    address: "Coleton Camp, Kingswear, TQ6 0EQ",
    url: "https://www.nationaltrust.org.uk/visit/devon/dartmouth-and-kingswear-countryside/car-parks-in-dartmouth-and-kingswear-countryside",
    // Charges and the overnight rule from the Trust's own car parks page.
    notes: "Twenty-five spaces in a field above Pudcombe Cove, the walkers' car park for this stretch of cliff and the back way into Coleton Fishacre; a track drops to the coast path and on to Scabbacombe Sands. Free to members, £1.20 an hour, £3.60 up to three hours or £4.80 all day otherwise, charged at all times; cash, or the JustPark app. Overnight parking is not allowed in any National Trust car park here. The separate Coleton Fishacre car park, half a kilometre south, is for visitors to the house and garden only",
    verified: "2026-09-16",
    stay: {
      type: "park4night",
      dogs: null,
  ...
  {
    slug: "hillhead-club-site",
    name: "Hillhead Brixham Club Campsite",
    kind: "stay",
    // Centre of OSM way 222757092, "Hillhead Caravan Club Site". The TQ5 0HH
    // postcode centroid, which the Club gives, is 190 m north-west.
    lat: 50.37030, lon: -3.54322,
    address: "Hillhead, Brixham, Devon, TQ5 0HH",
    phone: "01803 853204",
    url: "https://www.caravanclub.co.uk/club-sites/england/devon-and-cornwall/devon/hillhead-brixham-club-campsite/",
    // The Club's own site page. It was formerly a Parkdean holiday park and
    // directories still list it under that name.
    notes: "Twenty-two acres on the ridge above Man Sands, the biggest site anywhere near this section: 256 pitches, 243 touring and 13 camping, 111 of them hardstanding, all with 16 A hookup and many looking over Tor Bay. Outfits up to 8 m. Motorhome service point, wifi, laundry, accessible facilities and a shower room, shop, bar, restaurant and takeaway, games room, playground. Non-members are welcome. It reopened on 16 July 2026 after a long closure and runs to 4 January; 19 March to 3 January in 2027. Arrive from 1pm. The outdoor pool and the children's paddling pool are shut and due to reopen at the end of May 2027 — worth knowing if that is why you booked",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "Dogs are welcome, with a dog walk on the site and more nearby. No charge published",
      // The Club's 2026 dates. 2027 is 19 March to 3 January.
      season: { from: "07-16", to: "01-04" },
      price_per_night: null,
      price_note: "shown only in the booking system and changed fortnightly; the Club advertises £4 a night off on its South West Getaways, children 5–17 at £1 and under-5s free",
      hookup: true,
    },
  ...
  {
    slug: "wall-park-centry-road",
    name: "Wall Park Touring and Centry Road Camping",
    kind: "stay",
    // Centre of OSM way 953328959, "Wall Park Touring and Centry Road Camping".
    // The TQ5 9ET postcode centroid, which the owner gives, is 260 m south-west.
    lat: 50.39307, lon: -3.50230,
    address: "Centry Road, Berry Head, Brixham, Devon, TQ5 9ET",
    phone: "01803 856389",
    url: "https://www.centrytouring.co.uk/tariff",
    // The owner's own tariff page. No email published; booking is by phone or
    // through the site.
    notes: "Thirteen acres on the neck of the Berry Head peninsula, Brixham harbour on one side and St Mary's Bay on the other, with the path passing either end of it. Tents, trailer tents, caravans, motorhomes and RVs on grass, plus glamping pods and shepherd's huts; a newly built amenity block with free showers, a cycle route and a dog walk across the site. The Pearl & Oyster bar and snack shack on site. Only a limited number of 16 A hookups, which go early, so ask when booking. Two nights minimum over a Friday or Saturday. No generators. About fifteen minutes' walk down into Brixham, with a Co-op and a bus stop on Centry Road five minutes off. Seasonal long-stay pitches as well, £3,750 a year",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "The owner's tariff charges \"Dog (small size) £4.00 per night\" and the park has its own dog walk; no price is published for a larger dog, so say what you are bringing when you ring",
      // From the owner's own season dates, which run 1 March to 31 October.
      season: { from: "03-01", to: "10-31" },
      price_per_night: 28,
      price_note: "a pitch for two in low season — 1 March to 2 April, 7 to 29 April and October; £31 mid season and £38 high, which is 15 June to 13 September plus Easter and the two May bank holidays. Hookup £8.50, extra adult £5, child 5–15 £3, under-5s free, extra vehicle or trailer £3, pup tent £3, awning or gazebo free",
      hookup: true,
    },
  },
  {
    slug: "south-bay-holiday-park",
    name: "South Bay Holiday Park",
    kind: "stay",
    // Centre of OSM way 50905470, "South Bay Holiday Park". The TQ5 9QW
    // postcode centroid, which the owner gives, is 150 m west.
    lat: 50.38321, lon: -3.50956,
    address: "South Bay Holiday Park, St Mary's Road, Brixham, Devon, TQ5 9QW",
    phone: "01803 853004",
    url: "https://www.southbayholidaypark.co.uk/accommodation/camping-and-touring-holidays",
    // The owner's own camping and touring page. John Fowler Holidays; the park
    // is chiefly hire caravans, with a touring and camping field alongside.
    notes: "John Fowler holiday park on the hillside above St Mary's Bay, where the path climbs away from the beach, with a touring and camping field beside the hire caravans. Grass pitches with 16 A hookup for tourers and motorhomes, electric and non-electric tent pitches, an 8 m by 6 m part-hardstanding pitch and a 10 m by 8 m grass pitch for tents. Shower blocks, washing-up, fresh water, free hot water, waste disposal and parking; the pitch price includes the entertainment passes, so the indoor and outdoor pools, clubhouse, bar, shop, launderette and crazy golf come with it. One tent or outfit per pitch. Arrive from noon, leave by 10am, and no minimum stay. The park is steep — the owner warns it is unsuitable for anyone with mobility difficulties",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "Dogs are welcome on the touring and camping pitches, the owner's camping page says, and no pitch charge is published. The £30 a break or £50 a week, two dogs at most, applies to the hire caravans, which must be booked as pet properties",
      // The owner publishes no touring season dates.
      season: null,
      price_per_night: 15,
      price_note: "\"from just £15 per night fully inclusive of all entertainment passes and park facilities\"; the pitch type and the season set the rest, shown only in the online booking",
      hookup: true,
    },
  },
  {
    slug: "berry-head-hotel",
    name: "Berry Head Hotel",
    kind: "stay",
    // Centre of OSM way 1081558577, the hotel building; node 299712522 carries
    // the name 20 m north. The TQ5 9AJ postcode centroid, which the owner
    // gives, is 75 m north-west.
    lat: 50.40053, lon: -3.49471,
    address: "Berry Head Road, Brixham, Devon, TQ5 9AJ",
    phone: "01803 853225",
    email: "stay@berryheadhotel.com",
    url: "https://berryheadhotel.com/tariff",
    // The owner's own tariff page, priced through to the end of 2026. Sister
    // hotel to the Hannafore Point at Looe, already recorded for section 24.
    notes: "Privately owned four-star hotel in six acres of its own grounds inside Berry Head Country Park, on the shore below the headland with the coast path at the gate — a former military hospital of 1809, later the home of the man who wrote Abide With Me. En-suite bedrooms in several grades, and self-catering apartments as well. Indoor heated pool, spa bath and exercise area, a petanque court and a croquet lawn; the Bonaparte restaurant, the View brasserie and terrace, a Sunday carvery. Ample parking. Prices are a guide and the hotel asks that you confirm them before booking",
    verified: "2026-09-16",
    stay: {
      type: "hotel",
      dogs: true,
      dogs_note: "The owner's site calls it a \"Dog Friendly 4 Star South Devon Hotel\" and sets no room restriction; it publishes no charge, and the Dog Friendly directory gives £12 a dog a day with dogs on a lead in the hotel and grounds",
      season: null,
      price_per_night: 196,
      price_note: "a double or twin, bed and breakfast, for one night in spring or October 2026; £176 in winter, £230 from May to 18 July, £240 in high summer and £234 in September. Single occupancy is half. Room supplements per person per night: coastal view £15, sea view £20, balcony and sea view £30. Dinner, bed and breakfast adds £36 a head if booked with the room, £46 if not",
    },
  },
  {
    slug: "smugglers-hotel-brixham",
    name: "Smugglers Hotel",
    kind: "stay",
    // OSM node 7042119861, "Smugglers Haunt". The TQ5 8HH postcode centroid,
    // which the owner gives, is 26 m north-east.
    lat: 50.39488, lon: -3.51588,
    address: "Church Hill East, Brixham, Devon, TQ5 8HH",
    phone: "01803 853050",
    email: "bookings@smugglershotel.com",
    url: "https://smugglershotel.com/faqs/",
    // The owner's own FAQs. The £15 a dog and the designated rooms are a
    // booking site's, not the hotel's.
    notes: "Three-hundred-year-old building on Church Hill East, two minutes up from the harbour, run as a small hotel and restaurant with bed and breakfast. Twin, double and family rooms, most with beams and feature fireplaces, all with phone, TV and a tea tray; breakfast from local suppliers is included. There is a bar. No parking of its own — the town centre and Freshwater car parks are the nearest. Check in from 3pm, out by 10am",
    verified: "2026-09-16",
    stay: {
      type: "hotel",
      dogs: true,
      dogs_note: "\"Well-behaved dogs are welcome in the hotel and certain areas of the restaurant\", and the owner asks for notice in advance. No charge published; a booking site says £15 a dog a night to a maximum of £50 a stay, in designated rooms, and that dogs may not be left alone in a room",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
    },
  ...
  {
    slug: "harbour-view-brixham",
    name: "Harbour View",
    kind: "stay",
    // OSM node 1605452495, "Harbour View". The TQ5 9TH postcode centroid,
    // which the owner gives, is 32 m south-west.
    lat: 50.39641, lon: -3.51068,
    address: "65 King Street, Brixham, Devon, TQ5 9TH",
    phone: "01803 921808",
    email: "stay@harbourviewbrixhambandb.co.uk",
    url: "https://harbourviewbrixhambandb.co.uk/",
    // The owner's own site. Prices are shown only in their booking engine.
    notes: "The former harbourmaster's house, Grade II listed, standing on the inner harbour with the path along the quay outside. Eight rooms, each en-suite or with a private bathroom, goose down duvets, guest-controlled heating, TV and a tea tray; six look out over the harbour, and the two at the back over a courtyard, with exposed stone and original fireplaces. Full English breakfast from local suppliers, included. Harbourside parking £7 a night. Two minutes from the town centre. The owners also run Marina View nearby",
    verified: "2026-09-16",
    stay: {
      type: "bnb",
      dogs: true,
      dogs_note: "The two rear courtyard rooms take dogs; the six harbour-view rooms do not, so ask for a rear room when booking. No charge published, and the house makes a point of a breakfast sausage for the dog",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
    },
  ...
  {
    slug: "beacon-house-brixham",
    name: "Beacon House",
    kind: "stay",
    // Centre of OSM way 118932547, "Beacon House". The TQ5 8JB postcode
    // centroid, which the owner gives, is the same address.
    lat: 50.39724, lon: -3.51412,
    address: "Prospect Steps, South Furzeham Road, Brixham, Devon, TQ5 8JB",
    phone: "01803 428720",
    email: "enquiries@beaconbrixham.co.uk",
    url: "https://beaconbrixham.co.uk/rooms.html",
    // The owner's own rooms page. Recorded although it takes no animals: it is
    // one of the few places in Brixham with parking of its own.
    notes: "House of 1830 above the harbour bowl, reached by Prospect Steps, run by Hervé and Nathalie. Three rooms — Bay View, Harbour View and the Beacon Room — each with its own balcony looking over the marina and the breakwater. Private parking for one car a room, which is rare in Brixham. Breakfast is included and is the thing guests write about",
    verified: "2026-09-16",
    stay: {
      type: "bnb",
      dogs: false,
      dogs_note: "The owner's site says the house is animal free, and offers that as a feature; no dogs at all",
      season: null,
      price_per_night: 162,
      price_note: "Harbour View, the cheapest room, including breakfast and parking for one car; the Beacon Room from £167 and Bay View from £172, and £10 less in each for single occupancy",
    },
  },
  {
    slug: "driftwood-bandb-brixham",
    name: "Driftwood B&B",
    kind: "stay",
    // Centre of OSM way 118932566, "Driftwood B&B". The TQ5 8HS postcode
    // centroid, which the owner gives, is the same address.
    lat: 50.39632, lon: -3.51446,
    address: "11 Prospect Road, Brixham, Devon, TQ5 8HS",
    phone: "01803 858915",
    email: "stay@driftwoodbandb.co.uk",
    url: "https://www.driftwoodbandb.co.uk",
    // The owner's own site publishes no tariff, no parking and no dog policy.
    notes: "Five-star boutique bed and breakfast on Prospect Road above the harbour. Four en-suite rooms — Elberry, Churston, Oddicombe and Shoalstone — with Egyptian cotton, walk-in showers and either a balcony or a Juliette balcony over the sea. Cooked breakfast daily, full English, eggs benedict or smoked salmon and scrambled eggs, with diets catered for on notice. Adults only, and no smoking or vaping anywhere including the balconies. The owner warns of steep steps, stairs and roads: the house sits high in the harbour bowl and is not for anyone with mobility difficulties",
    verified: "2026-09-16",
    stay: {
      type: "bnb",
      dogs: null,
      dogs_note: "The owner's site says nothing about dogs either way, and nothing about parking; ring before counting on either",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
    },
  },
  {
    ...
    name: "Churston Court",
    kind: "stay",
    // Centre of OSM way 176532199, "Churston Court". The TQ5 0JE postcode
    // centroid, which the owner gives, is 64 m north-west.
    lat: 50.39738, lon: -3.54353,
    address: "Churston Court Manor House, Church Road, Churston Ferrers, Brixham, TQ5 0JE",
    phone: "01803 224101",
    url: "https://churstoncourt.com/stay/",
    // The owner's own stay page. OSM still tags it a pub with accommodation,
    // and CAMRA lists it as Churston Manor, but the restored house now sells
    // itself as an events and accommodation venue rather than a public bar, and
    // publishes no bar or food hours. Ring before turning up for a drink.
    notes: "Twelfth-century manor house beside Churston church, two kilometres inland of Brixham harbour, restored and reopened as a place to stay and to hold weddings and parties. Nine en-suite rooms in the old house, with exposed beams, thick stone walls and traditional furnishings, and nine contemporary en-suite rooms in the courtyard behind; Yarde Cottage, five bedrooms, is let whole. Up to 46 guests altogether. A bar, a restaurant and a garden; à la carte breakfast. Free private parking outside the rooms, with EV charging nearby, and Churston station on the steam line ten minutes off. Cots, high chairs and stair gates for small children. Enquiries go through the site or WhatsApp",
    verified: "2026-09-16",
    stay: {
      type: "hotel",
      dogs: true,
      dogs_note: "\"Churston Court warmly welcomes four legged guests and a few of the rooms are dog friendly\" — a few, not all, so name the dog when booking. No charge published",
      season: null,
      price_per_night: null,
      price_note: "not published; the owner takes enquiries rather than showing a tariff",
    },
  },
  {
    slug: "berry-head-car-park",
    name: "Berry Head car park",
    kind: "stay",
    // Centre of OSM way 27301925, the surfaced pay car park inside the fort at
    // the head; way 482268348, a grass overflow, adjoins it to the east. The
    // TQ5 9AP postcode the council gives is Gillard Road.
    lat: 50.39611, lon: -3.49166,
    address: "Berry Head, Gillard Road, Brixham, TQ5 9AP",
    url: "https://www.torbay.gov.uk/parking/car-parks/berry-head/",
    // Tariff from the council's own page; the overnight rule from its
    // campervans page. The £40 sign and the ANPR are park4night listing 266342,
    // rated 2.91 from 11, the latest June 2024 — treat both as dated.
    notes: "Torbay Council's car park at the turning point of the walk, inside the Napoleonic fort on Berry Head, with the nature reserve, the lighthouse and the Guardhouse café around it — and not a place to sleep: \"Overnight sleeping in vehicles or camping is not permitted, nor is the heating, cooking or preparing of food.\" Seventy-six spaces including seven disabled, open 24 hours, no height barrier; pay and display or RingGo, machines take cash and cards. An hour £1.90 rising to £11.00 for 17 hours. It is not one of the three Brixham car parks the council lists as suitable for campervans and motorhomes — a vehicle over one bay must pay for each bay and must not overhang. park4night reviewers report a £40 overnight charge signed here and ANPR that picks up a 35-minute stop, and a very narrow approach road that scrapes a motorhome",
    verified: "2026-09-16",
    stay: {
      type: "park4night",
      dogs: null,
      season: "all-year",
      price_per_night: null,
      price_note: "no night rate from the council: 17 hours is £11.00 and sleeping in a vehicle is banned. park4night reviewers report £40 signed for a night, undated",
      hookup: false,
    },
  },
  {
    slug: "breakwater-car-park-brixham",
    name: "Breakwater car park",
    kind: "stay",
    // Centre of OSM way 27430125, "Breakwater", Torbay Council, 103 spaces.
    // The TQ5 9AF postcode centroid, which the council gives, is 70 m north.
    lat: 50.39961, lon: -3.50434,
    address: "Berry Head Road, Brixham, TQ5 9AF",
    url: "https://www.torbay.gov.uk/roads/parking/car-parks/breakwater-cp/",
    // One of three Brixham car parks Torbay lists as suitable for campervans
    // and motorhomes; the others are Freshwater and Oxen Cove.
    notes: "The council car park behind Brixham breakwater beach, on the road out to Berry Head and on the path. One of only three car parks in Brixham the council lists as suitable for a campervan or motorhome — there is no height barrier — but that means parking, not staying: \"Overnight sleeping in vehicles or camping is not permitted, nor is the heating, cooking or preparing of food.\" A hundred and three spaces, three of them disabled, open 24 hours; pay and display or RingGo. Zone 2 rates, an hour £1.90 to £11.00 for 17 hours, charged on Sundays and bank holidays too. A vehicle taking more than one bay must buy a ticket for each and must not overhang the markings",
    verified: "2026-09-16",
    stay: {
      type: "park4night",
      dogs: null,
      season: "all-year",
      price_per_night: null,
      price_note: "no night rate: sleeping in a vehicle is banned. All day, to 17 hours, £11.00",
      hookup: false,
    },
  },
  {
    slug: "freshwater-oxen-cove-car-park",
    name: "Freshwater and Oxen Cove car parks",
    kind: "stay",
    // OSM node 1521221209, "Freshwater / Oxen Cove", Torbay Council, 214
    // spaces across the two. The council's own Freshwater page gives Blackball
    // Lane, TQ5 8BA, with 85 spaces.
    lat: 50.40083, lon: -3.51667,
    address: "Blackball Lane, Brixham, TQ5 8BA",
    url: "https://www.torbay.gov.uk/freshwater-cp",
    // Tariff and spaces from the council's own page; the overnight rule from
    // its campervans page. Reviews from park4night listing 146701, rated 3.55
    // from 11, the latest July 2026.
    notes: "Two adjoining council car parks on the western side of the harbour, Freshwater on Blackball Lane and Oxen Cove below it, five minutes from the town. Freshwater has 85 spaces, four disabled, one motorcycle and seven coach; CCTV, open 24 hours, no height restriction. Along with the Breakwater these are the Brixham car parks the council lists as suitable for a campervan or motorhome, but sleeping in one is banned across Torbay. Zone 2 rates, an hour £1.90 to £11.00 for 17 hours; commercial vehicles pay £18.80 for 17 hours. park4night reviewers report the sign against overnight camping, sea views, and bays narrow and short enough that a van over about 6 m needs two of them",
    verified: "2026-09-16",
    stay: {
      type: "park4night",
      dogs: null,
  ...
  // Section 42.
  {
    ...
    name: "Beverley Park",
    kind: "stay",
    // Centre of OSM way 31246145, "Beverley Holiday Park". The TQ4 7JE
    // postcode centroid, which the owner gives, is 135 m south-west.
    lat: 50.41354, lon: -3.56628,
    address: "Goodrington Road, Paignton, Devon, TQ4 7JE",
    phone: "01803 843887",
    email: "info@beverley-holidays.co.uk",
    url: "https://www.beverley-holidays.co.uk/accommodation/touring-camping/",
    // The owner's own touring and camping page and the Standard Electric pitch
    // page. Beverley Holidays runs three parks on the hill above Goodrington —
    // Beverley Park, Beverley Bay and Beverley View — and only Beverley Park
    // has touring and camping.
    notes: "Touring and camping fields on the hillside above Goodrington Sands, looking over Tor Bay, with the hire caravans and lodges alongside. Premier service and service hardstandings with electric and water, plain hardstandings with electric, grass pitches with electric for a tent, trailer tent, tourer or motorhome, and grass tent pitches with none; eight people a pitch at most. Upgraded facility blocks with underfloor heating and accessible facilities, free hot showers, family bathrooms and a launderette. The pitch price includes the entertainment and swimming passes, so the Oasis Leisure Club's indoor and outdoor pools, the Starlight Bar's cabaret and five eateries come with it. Open through the winter, when only the premier service and hardstanding pitches are bookable and some facilities are shut — the essentials, washing up, water and the launderette, stay open. Guests also have the run of Beverley Bay across the road, which has the dog walking field, the dog shower and its own outdoor pool. Goodrington Sands and the coast path are a short walk down",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "\"Dogs allowed all year round (please choose dog friendly on booking – there is a surcharge of £5 per dog per night)\", three dogs a pitch at most. There is a dog walking field and a warm dog shower on Beverley Bay",
      season: "all-year",
      price_per_night: null,
      price_note: "shown only in the online booking",
      hookup: true,
  ...
  {
    slug: "widdicombe-farm",
    name: "Widdicombe Farm Touring Park",
    kind: "stay",
    // Centre of OSM way 155436314, "Widdecombe Farm Touring Park" — OSM
    // spells it with an e. The TQ3 1ST postcode centroid is 245 m north.
    lat: 50.46680, lon: -3.58721,
    address: "Widdicombe Farm, Paignton, Devon, TQ3 1ST",
    phone: "01803 558325",
    email: "info@widdicombefarm.co.uk",
    url: "https://widdicombefarm.co.uk/faqs/",
    // The owner's own FAQs, pitch types and tariff pages. Run by three
    // generations of the Glynn family, who bought the farm in 1973.
    notes: "Adults-only touring park on eight acres of a working farm on the ridge behind Torquay, with views inland to Dartmoor. Over 180 all-weather gravel pitches, each with 10 A electric — a 10 m cable is needed — and room for a car, the unit and an awning side by side, with a patch of grass to sit out on; standard, semi-serviced with water and drainage, fully serviced with a chemical disposal point as well, premium with the best views and some big enough for an RV, plus a few camping pitches. Roomy showers, private washrooms and two accessible suites, laundry, small shop, wifi from Skylight Broadband. Gordon's Bar with live entertainment, bingo and quizzes on several nights, Poppies restaurant, and pizza, fish and chip and Thai vans on the evenings it is closed. No commercial vehicles. Check in from noon, arrive by 5pm and no siting after dusk; off by 11am. A supermarket half a mile away. The owner is emphatic about the route in: don't use Google Maps, which sends you down narrow lanes — follow the brown and white signs, and the directions on the owner's Find Us page",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "\"We accept dogs on the park at the owner's discretion.\" Three at most on a touring pitch, none in the amenity buildings, and dog-friendly seating in Poppies and in the bar, except on live entertainment nights. No charge published",
      // The owner gives the season only as "late March to Mid-October", with
      // no dates.
      season: null,
      price_per_night: null,
      price_note: "the owner's tariff page publishes no rates; a £50 deposit per unit per week or part week secures the booking, non-refundable, with the balance due on arrival by card or cash",
      hookup: true,
    },
  },
  {
    slug: "torquay-backpackers",
    name: "Torquay International Backpackers",
    kind: "stay",
    // OSM node 2076375610, "Torquay Backpackers". The TQ2 5NP postcode
    // centroid, which the owner gives, is 11 m away.
    lat: 50.46758, lon: -3.53418,
    address: "119 Abbey Road, Torquay, Devon, TQ2 5NP",
    phone: "01803 299924",
    url: "https://torquaybackpackers.co.uk/",
    // The owner's own site, which publishes no email and no season.
    notes: "Hostel in a listed Victorian terrace on Abbey Road, five minutes up from the seafront and the harbour and the only one anywhere near this stretch. Pod rooms and double rooms, some en-suite and some with a sea view. Self-catering kitchen, free tea and coffee, free wifi, a TV and DVD lounge, and a large beer garden with a barbecue. Trips out to Dartmoor are arranged from the hostel. Weekly and monthly rates as well as nightly, and a second mobile number, 07912 426252, for bookings",
    verified: "2026-09-16",
    stay: {
      type: "hostel",
      dogs: null,
      dogs_note: "the owner's site says nothing about dogs either way, so ring before booking",
      season: null,
      price_per_night: 25,
      price_note: "a pod room, or £110 a week and £400 a month; double rooms are quoted on enquiry",
    },
  },
  {
    slug: "walls-hill-car-park",
    name: "Walls Hill car park",
    kind: "stay",
    // Centre of OSM way 29075555, "Walls Hill Car Park". The TQ1 3LZ postcode
    // centroid is 25 m north.
    lat: 50.47726, lon: -3.51117,
    address: "Walls Hill, Babbacombe, Torquay, TQ1 3LZ",
    url: "https://www.torbay.gov.uk/parking/campervans/",
    // Rules quoted from the council's own campervan page, which also lists
    // every car park a campervan may use.
    notes: "Torbay Council car park on the headland above Anstey's Cove, where the path crosses the open grass of Walls Hill — and not a place to sleep: \"Overnight sleeping in vehicles or camping is not permitted, nor is the heating, cooking or preparing of food.\" It is on the council's list of car parks with no height barrier, so a campervan or motorhome may park by day, so long as it does not overhang a bay and pays for each bay it takes up, on pain of a penalty charge. The council points anyone wanting a night at the camping and caravanning sites around the bay. Torbay's other campervan car parks on this section are Abbey Park, Lymington Road, Meadfoot Beach, Melville Street, Princes Street, Sheddon Hill, St Marychurch, Town Hall, Brunswick Square, Chilcote Close and Hampton Avenue in Torquay, Youngs Park, Preston Gardens, Colin Road, Station Lane, Churchward Road and Clennon Valley in Paignton, and Breakwater, Freshwater and Oxen Cove in Brixham. This is a different rule from South Hams' — no Torbay car park takes a motorhome overnight at all",
    verified: "2026-09-16",
    stay: {
      type: "park4night",
      dogs: null,
      season: "all-year",
      price_per_night: null,
      price_note: "no night rate: sleeping in a vehicle is not permitted. Day charges are on the council's own car park charges page, and a vehicle over one bay buys a ticket for each",
      hookup: false,
    },
  },
  {
    slug: "babbacombe-beach-car-park",
    name: "Babbacombe Beach car park",
    kind: "stay",
    // Centre of OSM way 167067299, the pay car park at the foot of Beach Road,
    // next to the Cary Arms. The TQ1 3LX postcode centroid is 70 m north-west.
    lat: 50.47889, lon: -3.50959,
    address: "Beach Road, Babbacombe, Torquay, TQ1 3LX",
    // No council or operator page found for this one — it is not on Torbay's
    // list of campervan car parks. Everything here is from park4night listing
    // 450920, rated 4.35 from 17, so none of it is confirmed.
    notes: "The car park on the beach at the bottom of Babbacombe Beach Road, beside the Cary Arms and a few steps off the path where it drops to the shore. park4night reviewers report tickets sold for 24 hours at £20 and no sign forbidding a night, which is not the same as permission. The road down is the catch, and they are blunt about it: a 30 per cent hill, and never take anything bigger than a medium-wheelbase van down it, particularly in the wet. Toilets, a water point and bins by the beach. The cliff railway from Oddicombe and the walk down from Babbacombe Downs are the alternatives on foot",
    verified: null,
    stay: {
      type: "park4night",
      dogs: null,
      season: "all-year",
      price_per_night: null,
      price_note: "park4night gives £20 for 24 hours, undated",
      hookup: false,
    },
  },
  {
    slug: "cary-arms",
    name: "The Cary Arms & Spa",
    kind: "stay",
    food: { type: "pub" },
    // Centre of OSM way 166867990, "Cary Arms". The TQ1 3LX postcode centroid,
    // which the owner gives, is 40 m south-west.
    lat: 50.47896, lon: -3.50848,
    address: "Babbacombe Beach, Torquay, Devon, TQ1 3LX",
    phone: "01803 327110",
    email: "enquiries@caryarms.co.uk",
    url: "https://caryarms.co.uk/stay/dog-friendly-accommodation",
    // The owner's own dog-friendly page. Recorded because the dogs go in
    // ordinary luxury rooms, not only in the cottage and the suites.
    notes: "Inn on the beach at Babbacombe, at the foot of the cliff the path comes down, with a bar and restaurant open to walkers and terraces over Lyme Bay. Luxury rooms with king beds and a sea-facing balcony or terrace, two beach suites at sea level with private sundecks, duplex beach huts, the one- and two-bedroom Shell and Pebble suites, and a four-bedroom Beach Cottage with a garden and an open fire. Spa and treatments. The road down is a 30 per cent hill. There is an A la Bark menu for dogs — pork sausages, a chicken dinner and a doggy ice cream",
    verified: "2026-09-16",
    stay: {
      type: "inn",
      dogs: true,
      dogs_note: "\"Some of our accommodation is dog friendly and we welcome your canine companions with their own doggy beds, bowls and tasty treats.\" £25 a dog a night, and a dog-friendly room has to be booked by phone or email rather than online. Dogs are allowed in the main restaurant and the lounge",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
    },
  ...
  {
    slug: "downs-hotel-babbacombe",
    name: "The Downs",
    kind: "stay",
    // OSM node 2173208358, "The Downs". The TQ1 3LN postcode centroid, which
    // the owner gives, is 19 m west.
    lat: 50.47928, lon: -3.51376,
    address: "41–43 Babbacombe Downs Road, Babbacombe, Torquay, Devon, TQ1 3LN",
    phone: "01803 328543",
    email: "enquiries@downshotel.co.uk",
    url: "https://www.downshotel.co.uk/accommodation/dog-friendly/",
    // The owner's own dog-friendly page. It publishes no tariff and no room
    // count; rooms book through the site.
    notes: "Hotel on Babbacombe Downs Road, looking down the cliff over Lyme Bay, with the path along the Downs outside the door and the section's finish at the St Marychurch Road junction a few minutes on. Award-winning breakfasts, a lounge bar serving food, and a restaurant. Water bowls, towels and cold food storage for dogs. Walls Hill, Oddicombe and the cliff railway down to the beach are all within a walk",
    verified: "2026-09-16",
    stay: {
      type: "hotel",
      dogs: true,
      dogs_note: "\"We welcome responsible dog owners and all areas of the hotel are pet friendly with the exception of the restaurant.\" Dogs sit in the lounge bar at mealtimes or stay in the room, and go with you if you leave the hotel. \"Some rooms are not suitable for larger dogs so please do not hesitate to call us\". No charge published",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
    },
  ...
  {
    slug: "treacle-valley",
    name: "Treacle Valley Campsite",
    kind: "stay",
    // The TQ12 4ST postcode centroid; OSM has no feature for the site.
    // park4night's pin, listing 423543, is 270 m south-east.
    lat: 50.50180, lon: -3.55092,
    address: "Daccombe, Newton Abbot, Devon, TQ12 4ST",
    phone: "01803 328294",
    url: "https://www.treaclevalley.co.uk/campsite/",
    // The owner's own campsite page and FAQs. Formerly Manor Farm, and still
    // listed under that name in places; the family have run it since 2006.
    notes: "Easy-going traditional campsite in a steep-sided, west-facing valley at Daccombe, over the hill from Torquay, with 500-year-old oaks and a view to Dartmoor. An open field with no pitch markings: arrive when you like, pick your own spot, leave a car's width to the next tent, and register at the café in the morning. Tents, trailer tents and small campervans only — no caravans, and no motorhome with a factory-fitted toilet. No electric hook-up anywhere but the toilet block, where there are free sockets and charging boxes. Showers, laundry, covered outdoor washing up, a small shop and café open an hour or two in the morning, a children's playground, fire pits and firewood for sale. Open fires are allowed, which is rare. Reviewers warn that the trusting, unenforced feel cuts both ways on a summer Saturday night",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "\"We allow well-behaved dogs at Treacle Valley campsite, but they must be on a lead whenever there is the risk they might wander off.\" £2 a night, with areas to let a dog off the lead at times and woods to walk in",
      // The owner's season: Easter weekend to 30 September, opening Friday
      // 3 April in 2026.
      season: { from: "04-03", to: "09-30" },
      price_per_night: 19,
      price_note: "a small pitch; £19 to £30 by pitch size, a campervan priced as a large tent at £25, gazebo £4",
      hookup: false,
    },
  },
  {
    ...
    name: "Orestone Manor",
    kind: "stay",
    // Centre of OSM way 80431086, "Orestone Manor Hotel". The TQ1 4SX postcode
    // centroid, which the owner gives, is 90 m north-east.
    lat: 50.50144, lon: -3.52078,
    address: "Rock House Lane, Maidencombe, Torquay, Devon, TQ1 4SX",
    phone: "01803 897511",
    email: "reception@orestonemanor.co.uk",
    url: "https://www.orestonemanor.co.uk/faqs",
    // The owner's own FAQs for the pet policy. The dogs go in the Coach House
    // Suites — serviced hotel suites 50 m from the main house, not a
    // self-catering let — so the hotel is recorded.
    notes: "Country house hotel above Maidencombe, in gardens looking over Babbacombe Bay, with the path along the cliff below. Suites, deluxe, superior, standard sea view and standard rooms in the house, and the Coach House Suites 50 m away: a downstairs bedroom with an en-suite double shower opening onto a private courtyard with an outdoor hot tub, a living room upstairs and a balcony over the bay, with a parking space at the door. Room rates are room only unless stated. Restaurant, conservatory and terrace, with residents getting a discount on dinner",
    verified: "2026-09-16",
    stay: {
      type: "hotel",
      dogs: true,
      dogs_note: "\"Pets can be accomodated in our Coach House Suites\", booked direct with the hotel rather than online. \"Unless a specific pet package is booked there is a charge of £15 per dog per night.\" Non-residents may bring a well-behaved dog to eat or drink in the conservatory or on the terrace",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
    },
  ...
  {
    slug: "orchard-organic-farm",
    name: "The Hen's Dens at Orchard Organic Farm",
    kind: "stay",
    // The TQ12 4QP postcode centroid; OSM has no feature for the site.
    // park4night's pin, listing 585819 and rated 4.8 from 5, is 80 m east.
    lat: 50.51298, lon: -3.52254,
    address: "Gabwell Hill, Stokeinteignhead, Newton Abbot, Devon, TQ12 4QP",
    phone: "07805 894522",
    email: "info@orchardorganicfarm.co.uk",
    url: "https://orchardorganicfarm.co.uk/camping/camping-price-and-availability/",
    // The owner's own camping price page. The Hen's Dens themselves are
    // converted timber hen sheds let as glamping; the grass pitches in the
    // orchard are the camping.
    notes: "A few grass pitches in a quiet corner of the orchard on an organic farm above Maidencombe, with three timber tent Dens — converted laying-hen sheds sleeping five — let as glamping alongside. One tent and car, or one small campervan, to a pitch, and no sharing. Showers and toilets, a small games room for a wet day, and a communal kitchen with fridge, microwave and washing-up sink for the Dens; a cooker and cooking pack can be hired. The quietest place to stay on this stretch and about the only one between Babbacombe and Shaldon: Stokeinteignhead and the Church House Inn are twenty minutes' walk, Maidencombe beach and the coast path about the same. Coast path walkers get a discount, which the owner does not put a figure on",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "\"One well behaved dog £2.5 per stay\" — one dog, and the charge is per stay rather than per night",
      season: "all-year",
      price_per_night: 30,
      price_note: "high season, 1 April to 30 October; £20 a night low season, 1 November to 30 March. A den from £40. Cooker and cooking pack £30 a stay",
      hookup: true,
    },
  },
  {
    slug: "labrador-bay-car-park",
    name: "Labrador Bay car park",
    kind: "stay",
    // Centre of OSM way 5132480, "Labrador Bay", the RSPB reserve car park on
    // the A379. park4night's pin, listing 149802, is 20 m away.
    lat: 50.52353, lon: -3.51019,
    address: "Teignmouth Road, Shaldon, Devon",
    // No owner page fetched for the car park itself; the rule is from
    // park4night listing 149802, rated 4.09 from 11.
    notes: "The RSPB reserve car park on the Teignmouth Road above Labrador Bay, a few metres off the path and the only stopping place on the long open stretch between Maidencombe and Shaldon, with a sea view straight out of the windscreen. Not a place to sleep: park4night reviewers report a sign against overnight parking, and the A379 alongside is busy. Cirl buntings are what the reserve is for",
    verified: null,
    stay: {
      type: "park4night",
      dogs: null,
      season: "all-year",
      price_per_night: null,
      price_note: "no night rate: overnight parking is signed against. OSM records a day charge but no tariff",
      hookup: false,
    },
  },
  {
    slug: "longmeadow-farm",
    name: "Longmeadow Farm",
    kind: "stay",
    // Centre of OSM way 1514411613, "Longmeadow Farm Campsite". The TQ14 0EX
    // postcode centroid, which the owner gives, is 480 m north-east and covers
    // Coombe Road.
    lat: 50.53547, lon: -3.52597,
    address: "Longmeadow Farm, Coombe Road, Ringmore, Shaldon, Devon, TQ14 0EX",
    phone: "01626 872732",
    email: "anne@longmeadowfarm.co.uk",
    url: "https://www.longmeadowfarm.co.uk/campsite",
    // The owner's own campsite page, run by Anne and Hannah; mobiles
    // 07800 795532 and 07966 459166.
    notes: "Small campsite on a working sheep farm less than a mile from Shaldon, looking over the Teign. Tents and motorhomes by the night, on grass with electric hook-up if wanted, and a few hardstandings for motorhomes, first come first served. Touring caravans only by the season, Easter to the end of September — not by the night. Toilet and shower block renovated in 2022, with separate ladies', gents' and two family or unisex rooms, a washing-up area with a washing machine and a shared fridge and freezer. A dog exercise area beside the site. No commercial vehicles, no open fires, and no kites — there are cables overhead. Pitches from 2pm, off by noon, no arrivals after 9pm, and booking in advance with a deposit. The owner puts it plainly: no pub, no shop, no club, just relaxing camping. Cut-price pitches for walkers and cyclists with a small tent and no vehicle",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "\"Dogs are welcome but strictly to be kept on a lead\", under control, not left unattended, £2 a night; a dog exercise area adjoins the site",
      // The owner's season: Good Friday to 30 September — 3 April in 2026,
      // so the start date moves with Easter.
      season: { from: "04-03", to: "09-30" },
      price_per_night: 25,
      price_note: "a grass pitch for two in April, May, June and September; £30 on hardstanding, and £30 or £35 in July, August and bank holidays. Electricity £5, extra person £5, boat £5. A walker or cyclist with a small tent, no vehicle and no electricity pays £10, or £15 in high season",
      hookup: true,
    },
  },
  {
    slug: "ness-house-shaldon",
    name: "The Ness",
    kind: "stay",
    food: { type: "pub" },
    // OSM node 764892372, "The Ness", the pub itself. The TQ14 0HP postcode
    // centroid, which the owner gives, is 95 m south.
    lat: 50.53791, lon: -3.49913,
    address: "Ness Drive, Shaldon, Devon, TQ14 0HP",
    phone: "01626 873480",
    email: "nesshouse.shaldon@hall-woodhouse.co.uk",
    url: "https://www.theness.co.uk/stay",
    // The owner's own stay page. A Hall & Woodhouse pub with rooms; it
    // publishes no tariff, and rooms book online.
    notes: "Waterside pub with rooms on the Ness, above the mouth of the Teign where the path comes into Shaldon, with nine bedrooms done in a nautical style — en-suite shower or bathroom, smart TV, tea and coffee, desk, hairdryer — and a Luxury Room with a balcony, sea view and copper bath. Food from 9.30am to about 9pm every day, and the bar to 10.30 or 11pm. The smugglers' tunnel down to Ness Cove, where dogs are allowed all year, is a few minutes away, and Teignmouth is over the bridge or on the passenger ferry",
    verified: "2026-09-16",
    stay: {
      type: "inn",
      dogs: true,
      dogs_note: "\"We have a limited selection of dog friendly rooms available. Please call us if you would like to book a dog friendly room\" — they cannot be booked online. Dogs are welcome in the bar and music room for eating, and there is doggy ice cream. No charge published",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
    },
  ...
  {
    slug: "ladys-mile",
    name: "Lady's Mile Holiday Park",
    kind: "stay",
    // Centre of OSM way 254151237, "Lady's Mile Holiday Park". The EX7 0LX
    // postcode centroid, which the owner gives, is 700 m north-west, on
    // Exeter Road.
    lat: 50.59288, lon: -3.45617,
    address: "Exeter Road, Dawlish, Devon, EX7 0LX",
    phone: "01626 863411",
    email: "info@ladysmile.co.uk",
    url: "https://ladysmile.co.uk/accommodationtypes/touring-and-camping",
    // The owner's own touring page and pet-friendly page. Owner Jason Jeffery
    // also has Oakcliff at Dawlish Warren, which the booking form offers as
    // the alternative park.
    notes: "Big family park between Dawlish and Dawlish Warren, open all year. Hardstanding Haldon View pitches at the top with country views, Meadow and Top Meadow super pitches with electric, water and drainage, and four fields of grass pitches you pick from yourself; each has its own parking space, and electricity is included all year subject to fair use. Washing-up, hairdryers in the toilet blocks and a launderette. Indoor and outdoor pools, gym, arcade, playpark, pump track, restaurant, piano bar, marquee bar in summer, fish and chip shop at weekends and a convenience store. No same-day bookings, and touring and camping pitches are card payment only — no cash. About twenty minutes' walk down to the beach, the level coastal walk round to Dawlish town in the other direction",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "\"All pets stay for free\" on a dog-friendly pitch, two a unit, and the breed is asked for at booking; no dog named under the Dangerous Dogs Act 1991, muzzled or not. On a lead except in the dog field, which is not fully enclosed, and there is a free dog wash by the play park and a dog-friendly area of the clubhouse bar, patio and beer garden",
      season: "all-year",
      price_per_night: null,
      price_note: "shown only in the online booking",
      hookup: true,
  ...
  {
    slug: "leadstone-camping",
    name: "Leadstone Camping",
    kind: "stay",
    // The EX7 0NG postcode centroid, which the owner gives. OSM's unnamed
    // camp_site node 706751674 is 250 m north-east and park4night's pin,
    // listing 124965, 60 m south-east; the park is four fields, so the
    // centroid is the safest of the three.
    lat: 50.59425, lon: -3.45146,
    address: "Warren Road, Dawlish Warren, Dawlish, Devon, EX7 0NG",
    phone: "01626 911067",
    email: "enquiries@leadstoneholidaypark.co.uk",
    url: "https://leadstoneholidaypark.co.uk/tariff/",
    // The owner's own 2026 tariff and touring pages. Trading 52 years; an
    // emergency warden number, 07356 220355, is published as well.
    notes: "Traditional grass touring and camping park in four open fields above Dawlish Warren, ten minutes' walk from the beach with a bus stop at the gate and the station on foot. Owl is the largest field, with extra-large pitches to drive straight onto, a ramp to the shower block and the seasonal pitches; Badger is the lively one, with the play park and Amanda's catering horsebox; Fox is sheltered and quiet; Rabbit has nine pitches and sun all day. Tents, roof tents, caravans, campervans and motorhomes; the pitch rate covers two adults, the unit, one car, electric hook-up and water. Modern shower and toilet blocks, launderette, dog wash, family washroom and a small shop; showers are coin-operated, 20p for five minutes. Quiet hours 10.30pm to 8am, last check-in 8pm, and no same-day booking online — ring instead. Coming in, avoid Week Lane, which is very narrow, and take the next left into Warren Road",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "\"Dogs welcome\", free, and there is a dog wash on the park",
      // From the owner's own 2026 tariff bands, which run 1 April to
      // 23 September.
      season: { from: "04-01", to: "09-23" },
      price_per_night: 32,
      price_note: "a grass pitch with hook-up in low season; £35 standard and £40 peak, which is 22–31 May, 11 July to 31 August and bank holiday weekends. Extra adult £10, child over 4 £6, awning free, gazebo £5, extra car £5, dog free. A backpacker pitch is £18. Term-time midweek stays £25 to £28 with a discount code",
      hookup: true,
    },
  },
  {
    slug: "five-trees-camping",
    name: "Five Trees Camping",
    kind: "stay",
    // park4night's pin, listing 354965. The EX7 0NG postcode centroid, which
    // the owner gives and which Leadstone shares, is 70 m south; OSM has no
    // feature for the site.
    lat: 50.59487, lon: -3.45133,
    address: "The Field, Warren Road, Dawlish Warren, Devon, EX7 0NG",
    phone: "07869 259421",
    email: "info@fivetreescamping.co.uk",
    url: "https://www.fivetreescamping.co.uk/",
    // The owner's own site. It publishes no tariff and no season dates, only
    // that bookings are open for July and August.
    notes: "An acre and a half of grass ten minutes' walk from the Blue Flag beach at Dawlish Warren, with electric pitches about 10 m by 8 m and non-electric about 8 m by 8 m. Tents, trailer tents and campervans under 6 m only — no caravans and no motorhomes of any size, under the site licence. One vehicle a pitch, parked on it, and no other parking. A pre-erected bell tent to hire, paddleboards for guests, modern toilets and showers, a wash-up area and a small shop. Gas and electric barbecues but no charcoal and no open fires. Shops, takeaways and pubs are a short walk, and dogs are allowed on the beach all year between groynes 3 and 9",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "\"We're also dog-friendly, because we know a holiday isn't complete without your four-legged friend (just keep them on a lead and tidy up after them)\". No charge published",
      season: null,
      price_per_night: null,
      price_note: "not published on the owner's site; a directory gives from £33 a night, undated",
      hookup: true,
    },
  },
  {
    slug: "dawlish-warren-car-park",
    name: "Dawlish Warren car park",
    kind: "stay",
    // Centre of OSM way 38162035, "Dawlish Warren", tagged fee 09:00–18:00.
    // A second council car park, way 38163260, is 300 m north-east. The
    // EX7 0NF postcode centroid is 150 m north.
    lat: 50.59656, lon: -3.44401,
    address: "Dawlish Warren, Dawlish, Devon, EX7 0NF",
    url: "https://www.teignbridge.gov.uk/parking/car-parks/find-a-car-park/",
    // Teignbridge publishes no motorhome or overnight policy on its parking
    // pages, and the car park detail sits inside a map. What is here is from
    // park4night listings 602630 and 124965 and from OSM, so none of it is
    // confirmed by the council.
    notes: "The council car parks behind Dawlish Warren, on the path and a few minutes from the beach, the pub, the arcades and the station. Pay by meter or app, cheap and quiet by park4night's account, with a drinking water point and public toilets a short walk off, though the toilets are not open round the clock; trains pass close by at night. Teignbridge ran a trial years ago letting self-contained motorhomes stay 6pm to 9am on the landward side, free, two nights at most, and the same at East Cliff in Teignmouth — that shows up all over the forums, but the council publishes nothing about it now and a 2024 park4night review says camping is no longer allowed here. Treat it as a day car park until the council says otherwise; Teignbridge's rules are not Torbay's, and neither is published as clearly as South Hams'",
    verified: null,
    stay: {
      type: "park4night",
      dogs: null,
      season: "all-year",
      price_per_night: null,
      price_note: "no night rate published; OSM records charges from 9am to 6pm",
      hookup: false,
    },
  },
  {
    slug: "cofton-holidays",
    name: "Cofton Holidays",
    kind: "stay",
    // Centre of OSM way 121929656, "Cofton Holidays". The EX6 8RP postcode
    // centroid, which the owner gives, is 155 m north.
    lat: 50.61124, lon: -3.45985,
    address: "Starcross, Dawlish, Devon, EX6 8RP",
    phone: "01626 890111",
    email: "info@coftonholidays.co.uk",
    url: "https://coftonholidays.co.uk/accommodation/campsites-devon/touring-caravan-site-in-devon/",
    // The owner's own touring page and FAQs. Family-run for over 40 years,
    // 450 touring pitches in 80 acres.
    notes: "Large five-star touring park in a wooded valley behind Cockwood, open all year, with lodges, cottages and static caravans on the same 80 acres. Fully serviced super pitches with electric, water and waste, hardstandings, RV pitches, level or terraced grass pitches with electric for summer, and accessible pitches close to the blocks; each is marked out with room for an awning and a car, and you can book the exact pitch you want. Heated toilet and shower blocks, covered washing up, motorhome service points, water and grey and chemical waste points through the fields, launderette, shop and wifi. Indoor and outdoor pools with a splash zone, sauna, steam room and gym, the Swan pub and restaurants, coarse fishing lakes, e-bike hire, high ropes and nightly entertainment. Check in noon, out 10am. About thirty minutes' walk through the park's own woodland to Dawlish Warren beach, ten by road, and a bus to Exeter or Newton Abbot stops a hundred yards from reception",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "\"All our touring pitches are dog friendly\", two a pitch, on a lead on site, with a secure dog-walking field and a dog wash. No charge published for a pitch dog",
      season: "all-year",
      price_per_night: null,
      price_note: "shown only in the online booking, and electricity is charged on top by meter at 30p a kWh through the Metpow app, with a card pre-authorisation on arrival and a holding charge until you leave",
      hookup: true,
    },
  },
  {
    slug: "croft-guest-house-cockwood",
    name: "The Croft Guest House",
    kind: "stay",
    // The EX6 8QY postcode centroid, which directories give; OSM has no
    // feature for the house.
    lat: 50.61836, lon: -3.44958,
    address: "Cockwood Harbour, Starcross, Devon, EX6 8QY",
    phone: "01626 890282",
    email: "croftcockwood@aol.com",
    // thecroftcockwood.com, the address the National Trails listing gives,
    // now returns 404, so everything here comes from directory listings and
    // none of it is confirmed by the owner.
    notes: "Guest house in an acre of gardens with a pond and a waterfall, looking over Cockwood harbour and the Exe, on the path between Dawlish Warren and Starcross and a mile from the ferry. Eight rooms, en-suite shower and WC, flat-screen TV and tea and coffee; full English breakfast at your own table in the dining room, with gluten-free by arrangement. Free off-road parking for a car or a boat, free wifi, and your own key to the front door. Directories say adults only, no children or babies. Worth ringing before relying on any of this — the website the National Trails accommodation listing gives has gone",
    verified: null,
    stay: {
      type: "bnb",
      dogs: null,
      dogs_note: "directories call it adults and pet friendly, and reviewers stay with dogs, but there is no owner's site left to confirm it on",
      season: null,
      price_per_night: null,
      price_note: "a booking site quotes £80 to £85 for two and singles from £56, undated",
    },
  },
  {
    slug: "cockwood-strand-parking",
    name: "The Strand, Cockwood",
    kind: "stay",
    // Centre of OSM way 892825784, the street-side parking on the bend of the
    // Strand. park4night's pin, listing 342767, is 15 m away.
    lat: 50.61894, lon: -3.44771,
    address: "The Strand, Cockwood, Starcross, Devon, EX6 8QY",
    // No council page found for this parking; everything is from park4night
    // listing 342767, rated 3.4 from 5, so none of it is confirmed.
    notes: "Roadside parking on the bend of the Strand at Cockwood, right on the coast path and the Exe Estuary cycle trail, by the harbour and the two pubs — the Anchor and the Ship. park4night has it as a day and night parking spot: the road is busy through the day and quiet at night. Starcross, the station and the Exmouth ferry are about a mile on. Nothing here says a night is permitted, only that nothing says it isn't",
    verified: null,
    stay: {
      type: "park4night",
      dogs: null,
      season: "all-year",
      price_per_night: null,
      price_note: "no charge recorded",
      hookup: false,
    },
  },
  {
    slug: "hunters-lodge-starcross",
    name: "Hunters Lodge",
    kind: "stay",
    // OSM node 6344943127, "Hunters Lodge Caravan and Camping". The EX6 8FL
    // postcode centroid, which the owner gives, is 135 m north-east.
    lat: 50.62257, lon: -3.45755,
    address: "Hunters Lodge Camping Site, Starcross, Exeter, Devon, EX6 8FL",
    phone: "07718 090345",
    email: "hunters.lodge@hotmail.com",
    url: "https://www.hunterslodge-camping.co.uk/tariff",
    // The owner's own tariff and location pages, run by Paul. A Freedom
    // Camping certified site, so five units at a time.
    notes: "Small adults-only Freedom Camping certified site — five units at a time — in ten acres of its own valley on the edge of Starcross, the closest place to stay to the ferry. Hardstanding pitches for caravans and motorhomes, and standard pitches for a tent, trailer tent or campervan up to 5.5 m; 16 A electric included on every pitch. Hot showers for a small charge in a private bathroom with toilet and basin, laundry room with washing machine, deep sink and ice-pack freezer, stainless steel chemical disposal point, and wifi for a charge. Owls at night, deer in the valley and a kingfisher on the lake. Two nights minimum and no Sunday arrivals. A bus stop five minutes down the lane, the station fifteen minutes' walk, the Exmouth ferry fifteen, Dawlish Warren beach forty and Powderham Castle forty",
    verified: "2026-09-16",
    stay: {
      type: "cl",
      dogs: null,
      ...
      season: null,
      price_per_night: 30,
      price_note: "a standard pitch for a tent, trailer tent or campervan up to 5.5 m, covering two adults, one car and 16 A electric; a hardstanding for a caravan or motorhome from £38",
      hookup: true,
    },
  },
  // Section 44.
  {
    slug: "maer-road-car-park",
    name: "Maer Road car park",
    kind: "stay",
    // Centre of OSM way 73235044, "Maer Road Long Stay", 217 spaces, operator
    // East Devon District Council.
    lat: 50.61277, lon: -3.39914,
    address: "Maer Road, Exmouth",
    url: "https://eastdevon.gov.uk/community-engagement/previous-consultationsurvey-updates/place/overnight-motorhome-parking-in-eddc-car-parks-exmouth/",
    // One of only two car parks in the whole district where East Devon District
    // Council permits sleeping in a vehicle. The council's own parking pages
    // carry the daytime tariff but not the overnight scheme, so the terms below
    // come from its consultation page and from press coverage of the August
    // 2025 decision — dated facts, worth confirming in RingGo before relying on
    // them.
    notes: "Long stay car park behind the dunes at the Maer, where the seafront walk starts, and a designated overnight motorhome stopover — the council's answer to wild camping along Queen's Drive. £20 a night, paid through the RingGo app only; two nights at most, and the vehicle may not return within 72 hours. A freshwater tap and disposal points for shower, dishwater and chemical toilet waste were approved in August 2025. £5 of each overnight fee is put to parking and anti-social behaviour enforcement. Daytime pay and display is unaffected. Nowhere else on these two sections allows it: sleeping in a vehicle is not permitted in East Devon's car parks at Budleigh Salterton, Sidmouth, Beer or Seaton",
    verified: null,
    stay: {
      type: "aire",
      dogs: null,
      season: "all-year",
      price_per_night: 20,
      price_note: "the overnight motorhome rate, raised from £11 in 2025; RingGo only, and daytime parking is charged separately",
      hookup: false,
    },
  },
  {
    slug: "queens-drive-echelon",
    name: "Queen's Drive Echelon",
    kind: "stay",
    // Centre of OSM way 695964058, "Queens Drive Car Park", 118 spaces,
    // operator East Devon District Council. OSM does not use the council's name
    // "Echelon" for the angled bays along the drive; they are inside this way.
    lat: 50.61296, lon: -3.40734,
    address: "Queen's Drive, Exmouth",
    url: "https://eastdevon.gov.uk/community-engagement/previous-consultationsurvey-updates/place/overnight-motorhome-parking-in-eddc-car-parks-exmouth/",
    // The second of the council's two overnight sites. Terms as Maer Road, from
    // the same consultation page and press coverage rather than the tariff page.
    notes: "Angled bays on the seafront drive itself, with the path along the promenade and the sea over the wall — the closer of the two Exmouth overnight motorhome stopovers to the start of the walk, and the more exposed. £20 a night through RingGo only, two nights at most, no return within 72 hours. New bay markings were laid in 2025 to keep vehicles a safe distance apart. No water or waste disposal here: those were approved for Maer Road, a kilometre east",
    verified: null,
    stay: {
      type: "aire",
      dogs: null,
      season: "all-year",
      price_per_night: 20,
      price_note: "the overnight motorhome rate; RingGo only",
      hookup: false,
    },
  },
  {
    slug: "prattshayes-campsite",
    name: "Exmouth Country Lodge & Prattshayes Campsite",
    kind: "stay",
    // Centre of OSM way 160836891, "Pratshayes Farm". The EX8 5DB postcode
    // centroid, which the owner gives, is 130 m north-east.
    lat: 50.61784, lon: -3.38069,
    address: "Maer Lane, Exmouth, Devon, EX8 5DB",
    phone: "01395 276626",
    email: "info@prattshayescampsite.co.uk",
    url: "https://www.prattshayescampsite.co.uk/",
    // The owner's own site gives the address, the pitch types and the hookups
    // but publishes no tariff, no season and no dog policy; booking is through
    // FreeToBook. Directories put it at 40 to 62 pitches and open all year.
    notes: "Farm campsite in the Littleham valley behind the town, a mile up Maer Lane from the beach and the same again from the Sandy Bay cliffs. Grass touring and camping pitches and hardstandings, hedge-lined, with electric hookups; new shower, toilet and washing-up block, and a reception with a bar. The owners also let a country lodge and a cottage, each sleeping fourteen. The site runs on solar and thermal energy and sends nothing to landfill",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: null,
      dogs_note: "Directories list it as dog friendly; the owner's own site says nothing either way",
      season: null,
      price_per_night: null,
      price_note: "not published; pitches book through the owner's system",
      hookup: true,
    },
  },
  {
    slug: "royal-beacon-hotel",
    name: "The Royal Beacon Hotel",
    kind: "stay",
    // OSM node 3721211362, "Royal Beacon Hotel". The EX8 2AF postcode centroid,
    // which the owner gives, is 60 m north-east.
    lat: 50.61599, lon: -3.41219,
    address: "The Beacon, Exmouth, Devon, EX8 2AF",
    phone: "01395 224488",
    url: "https://richardsonhotels.co.uk/royal-beacon-hotel/your-stay",
    // The owner's own "your stay" page for the dog charge and the parking.
    notes: "Georgian coaching house on the Beacon, the terrace above the seafront, looking over the Exe estuary — a Richardson hotel with a restaurant and bar. Check in from 3pm. Free street parking outside on a first-come basis, or a reserved space in the hotel's own car park for £10 a night, which is worth having in Exmouth",
    verified: "2026-09-16",
    stay: {
      type: "hotel",
      dogs: true,
      dogs_note: "\"Dogs are charged at an additional £20 per dog, per night.\" A limited number of dog-friendly rooms, which must be reserved in advance; the hotel's blog says each has a dog bed, towel, torch and bowl",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
    },
  ...
  {
    slug: "pooh-cottage-holiday-park",
    name: "Pooh Cottage Holiday Park",
    kind: "stay",
    // Centre of OSM way 34118147, "Pooh Cottage Holiday Park". The EX9 7AQ
    // postcode centroid, which the owner gives, is 135 m north.
    lat: 50.64018, lon: -3.34292,
    address: "Bear Lane, Budleigh Salterton, Devon, EX9 7AQ",
    phone: "01395 442354",
    email: "bookings@poohcottage.co.uk",
    url: "https://poohcottage.co.uk/",
    // The owner's own site. It publishes no tariff, no season and no dog rules;
    // rates are in the booking system.
    notes: "Eight acres on the hill above Budleigh Salterton, a mile from the town and the beach, with views over the Otter valley to the sea. Touring and camping pitches, some fully serviced, with electric points and hookups; luxury shower and toilet block, laundry and pot wash, chemical and grey water disposal, EV charging, free wifi, play area and visiting catering vans. Seasonal pitches for 2026 as well",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: null,
      dogs_note: "The owner calls the park \"dog & child friendly\" but sets out no rules and no charge",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
      hookup: true,
  ...
  {
    slug: "feathers-hotel-budleigh",
    name: "The Feathers Hotel",
    kind: "stay",
    food: { type: "pub" },
    // OSM node 292003547, "The Feathers Hotel". The EX9 6LE postcode centroid
    // is 43 m west.
    lat: 50.62947, lon: -3.32721,
    address: "35 High Street, Budleigh Salterton, Devon, EX9 6LE",
    phone: "01395 708852",
    // No website of its own could be found. Details are from CAMRA's WhatPub
    // entry and the Dog Friendly directory, neither of them the owner's, so
    // nothing here is confirmed.
    notes: "Sixteenth-century pub on the High Street, a few minutes up from the beach, with four en-suite bedrooms. Public bar with a pool table and sport on the TV leading to a skittle alley that doubles as a function room, and a separate lounge bar and restaurant doing home-cooked food at lunchtime and in the evening",
    verified: null,
    stay: {
      type: "inn",
      dogs: null,
      dogs_note: "The Dog Friendly directory says dogs are welcome inside and out and are given biscuits and water; the pub publishes nothing of its own, and whether that extends to the bedrooms is unrecorded",
      season: null,
      price_per_night: null,
      price_note: "not published",
    },
  ...
  {
    slug: "kings-arms-otterton",
    name: "The Kings Arms",
    kind: "stay",
    food: { type: "pub" },
    // Centre of OSM way 246336235, "The Kings Arms". The EX9 7HB postcode
    // centroid, which the owner gives, is 130 m north-east.
    lat: 50.65986, lon: -3.30123,
    address: "Fore Street, Otterton, Devon, EX9 7HB",
    phone: "01395 568416",
    email: "info@kingsarmsotterton.co.uk",
    url: "https://www.kingsarmsotterton.co.uk/dog-friendly",
    // The owner's own dog-friendly page. No tariff is published; rooms are
    // booked through the site or by phone.
    notes: "Village pub in Fore Street at Otterton, on the lane inland from Ladram Bay and a walk up the Otter from the South Farm footbridge the path crosses. Fourteen bed and breakfast rooms. Kitchen midday to 8.30pm Monday to Saturday, to 7.30pm on Sunday, with a Sunday carvery. Check in from 3pm, out by 11am",
    verified: "2026-09-16",
    stay: {
      type: "inn",
      dogs: true,
      dogs_note: "\"We're also happy to accommodate dogs whose owners are staying overnight; all of our rooms are dog-friendly.\" No charge published; the pub asks you to ring ahead to discuss what you need",
      season: null,
      price_per_night: null,
      price_note: "not published; rooms book through the owner's site or by phone",
    },
  },
  {
    slug: "ladram-bay-holiday-park",
    name: "Ladram Bay Holiday Park",
    kind: "stay",
    // Centre of OSM way 118550554, "Ladram Bay Holiday Park". The EX9 7BX
    // postcode centroid, which the owner gives, is 125 m east.
    lat: 50.66056, lon: -3.28132,
    address: "Otterton, Budleigh Salterton, Devon, EX9 7BX",
    phone: "01395 568398",
    email: "info@ladrambay.co.uk",
    url: "https://www.ladrambay.co.uk/touring",
    // The owner's own touring page for the pitch types; the dog limit is from
    // the booking pages. The £30-a-break dog fee the park advertises is for its
    // hire caravans, not for a pitch, and no pitch dog charge is published.
    notes: "Big family holiday park in the valley behind the red sea stacks, with the path running along the cliff above it — the one place to stay on the stretch between Budleigh Salterton and Sidmouth. Level hardstanding touring pitches, all fully serviced with electric hookup, water and grey waste drainage, in four sizes: campervan and motorhome only up to 21ft on Hillside or 25ft on the Ridges, and touring caravan or motorhome up to 27ft on Hillside or 30ft on the Ridges. Bookings of one to fourteen nights. Pebbles restaurant, swimming pool, bars, shop, evening entertainment and a private beach. Phone lines 9am to 5pm",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "Up to three dogs a booking. Dogs are not allowed on the park's private beach at any time of year — this is the one place on the section where the shore is closed to them year-round rather than only in summer",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
      hookup: true,
  ...
  {
    slug: "bedford-hotel-sidmouth",
    name: "The Bedford Hotel",
    kind: "stay",
    // OSM node 1598938801, "Bedford Hotel". The EX10 8NR postcode centroid,
    // which the owner gives, is 9 m away.
    lat: 50.67780, lon: -3.23988,
    address: "Esplanade, Sidmouth, Devon, EX10 8NR",
    phone: "01395 513047",
    email: "reservations@bedfordhotelsidmouth.co.uk",
    url: "https://www.bedfordhotelsidmouth.co.uk/tariff-terms-and-conditions/",
    // The owner's own tariff terms for the dog charge and the parking. The
    // detail about all rooms taking dogs and the treat on arrival is from the
    // hotel's own dog-friendly page.
    notes: "Regency hotel on the Esplanade, at the end of the day's walk, with a restaurant and a bar. Very limited parking of its own at the rear, first come first served and keys left at reception; the public car park opposite takes the overflow, or Manor Road ten minutes away. Prices are per room per night and inclusive",
    verified: "2026-09-16",
    stay: {
      type: "hotel",
      dogs: true,
      dogs_note: "\"£10 per dog, per night\", and the hotel's own dog-friendly page says every room takes dogs, up to two, with a treat on arrival and a dog-friendly part of the dining room so the dog eats with you. Dog food is not provided",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
    },
  ...
  {
    slug: "kingswood-hotel-sidmouth",
    name: "The Kingswood Hotel",
    kind: "stay",
    // OSM node 1598938802, "The Kingswood Hotel". The EX10 8AX postcode
    // centroid, which the owner gives, is 9 m away.
    lat: 50.67803, lon: -3.23880,
    address: "The Esplanade, Sidmouth, Devon, EX10 8AX",
    phone: "01395 513151",
    url: "https://kingswoodsidmouth.co.uk/terms-conditions/",
    // The owner's own terms for the dog policy and the parking. OSM carries an
    // older number, 01395 513320.
    notes: "Family-run seafront hotel on the Esplanade, over seventy years in the same hands, with en-suite rooms, a bar and a restaurant. Free parking, first come first served. Rooms are ready at 3pm, checkout is 10.30am and the hotel asks that the car park is clear by noon",
    verified: "2026-09-16",
    stay: {
      type: "hotel",
      dogs: true,
      dogs_note: "\"Well behaved and house-trained dogs are welcome at in specified rooms with a maximum of two dogs per room\" at £10 a night. Tell the hotel before you book — it may not be able to take the dog if you don't. Bowls are lent; dog food is not provided",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
    },
  ...
  {
    slug: "royal-york-faulkner-hotel",
    name: "Royal York & Faulkner Hotel",
    kind: "stay",
    // OSM node 1598945451, "Royal York & Faulkner Hotel". The EX10 8AZ postcode
    // centroid, which the owner gives, is 12 m away.
    lat: 50.67837, lon: -3.23687,
    address: "Esplanade, Sidmouth, Devon, EX10 8AZ",
    phone: "01395 513043",
    email: "stay@royalyorkhotel.co.uk",
    url: "https://www.royalyorkhotel.co.uk/tariff/room-rates",
    // The owner's own room rates page for the dog charge; the terms page for
    // the parking. A pet directory gives £8 a dog and two dogs a room, which
    // the hotel's own figure contradicts — treat the directory as stale.
    notes: "Regency hotel under the colonnade on the Esplanade, family run, with a restaurant, a spa, three lounges and Blinis café-bar. Private car park at the rear, limited and not reservable, keys left at reception. Rates are per person per night and take in a full English breakfast, a four-course dinner, coffee and afternoon tea",
    verified: "2026-09-16",
    stay: {
      type: "hotel",
      dogs: true,
      dogs_note: "\"We do welcome dogs at a charge of £10 daily. Please note – they are not permitted in any of the public rooms (except service dogs).\" That rules out the lounges and the restaurant, so meals mean leaving the dog in the room",
      season: null,
      price_per_night: null,
      price_note: "per person, not per room, and half board: a standard room is £141–£151 a head a night from June to September 2026 and £91–£96 in winter, deluxe £11–£15 more; bed and breakfast only takes £25 a head off",
    },
  },
  {
    slug: "salty-monk",
    name: "The Salty Monk",
    kind: "stay",
    // OSM node 556657770, "The Salty Monk". The EX10 9QP postcode centroid,
    // which the owner gives, is 22 m away.
    lat: 50.70288, lon: -3.22383,
    address: "Church Street, Sidford, Sidmouth, Devon, EX10 9QP",
    phone: "01395 513174",
    email: "hello@saltymonk.com",
    url: "https://www.saltymonk.com/Sleep/Dogs",
    // The owner's own dogs page, which prices the three dog rooms outright —
    // rare enough to be worth recording.
    notes: "Restaurant with rooms at Sidford, up the Sid valley from Sidmouth: a sixteenth-century salt house, seven bedrooms, gardens. Restaurant Tuesday to Saturday, last orders 9pm. The three ground-floor dog rooms have their own way out to the garden — Wisteria at 32 square metres, Heather, which converts to a twin, and Rose. Rates include a full English breakfast",
    verified: "2026-09-16",
    stay: {
      type: "bnb",
      dogs: true,
      dogs_note: "\"We allow dogs in three of our Seven bedrooms, that are on the ground floor with their own access to outside\", £20 a dog for the whole stay rather than per night. Dogs may sit with you at meals in the marked dining areas, on a lead, but not at the buffet. A welcome hamper with bowl, treats, towel, bags, torch and feeding mat; an outside shower for muddy paws, and leads and a cage to borrow. On a lead near the road",
      season: null,
      price_per_night: 140,
      price_note: "Heather or Rose as a double, with breakfast; Wisteria £180, and £110 for single occupancy of any of the three",
    },
  },
  // Section 45.
  {
    slug: "salcombe-regis-camping",
    name: "Salcombe Regis Camping & Caravan Park",
    kind: "stay",
    // Centre of OSM way 180214198, "Salcombe Regis C. & C. Park". The EX10 0JH
    // postcode centroid, which the owner gives, is 170 m south-west.
    lat: 50.69459, lon: -3.20483,
    address: "Salcombe Regis, Sidmouth, Devon, EX10 0JH",
    phone: "01395 514303",
    email: "contact@salcombe-regis.co.uk",
    url: "https://www.salcombe-regis.co.uk/touring-and-motorhomes/",
    // The owner's own touring page, priced for 2026. The 2026 opening date is
    // not published; 2025 opened on 22 March.
    notes: "AA five-pennant gold award park down a quiet lane behind Salcombe Hill, the first climb out of Sidmouth, with a path down to Salcombe Mouth. Mostly hardstanding pitches with electric hookup and water, some with grey water soakaways and gravel awning bases; grass pitches too, on the perimeter and in the middle of the field. A few extended pitches take American motorhomes — ring first if you are long. Two shower and washroom blocks, wifi, badminton and table tennis, and an acre of partly wooded dog field. Folk Week, 31 July to 7 August, is a seven-night minimum",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "Two dogs a pitch at £3.85 a dog a night, with an acre of dog field where they can run free",
      season: null,
      price_per_night: 29,
      price_note: "a touring pitch without electric at the bottom of the 2026 range, £35.50 at the top; £35.50–£41 with hookup, and peak season is 3 July to 6 September. Extra adult £6.75, child 5–15 £4.50, extra vehicle £8",
      hookup: true,
    },
  },
  {
    slug: "oakdown-holiday-park",
    name: "Oakdown Holiday Park",
    kind: "stay",
    // Centre of OSM way 33178876, "Oakdown". The EX10 0PT postcode centroid,
    // which the owner gives, is 160 m south-west.
    lat: 50.70580, lon: -3.17910,
    address: "Gatedown Lane, Sidmouth, Devon, EX10 0PT",
    phone: "01297 680387",
    email: "enquiries@oakdown.co.uk",
    url: "https://www.oakdown.co.uk/dog-friendly-touring-camping/",
    // The owner's own dog-friendly and touring pages. The dog charge is in the
    // booking system only, which is why there is no figure here.
    notes: "Ninety-seven level landscaped pitches off the A3052 three miles inland of Sidmouth, in three grades — non-serviced, serviced with electric on grass or hardstanding, and super serviced with water and grey waste as well. Touring caravans, motorhomes, tents, trailer tents and folding campers, with limited room for American motorhomes. Two amenity blocks with showers and laundry, a nine-hole golf course, bird hides, play areas, the Oak Mead café and a field trail to the Donkey Sanctuary from the gate. Bus 899 to Sidmouth and Branscombe passes the entrance. AA five pennant platinum for 2026/7, and Practical Caravan's best pet-friendly site 2026",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "Dogs on every touring pitch, on a lead throughout the park and never left alone on a pitch or in a vehicle. A charge per dog per night, shown only when booking. A free Clean Paws dog spa with bath, hot shower and dryer, waste bins through the park, treats and shampoo in the shop, a doggy menu in the café, and pup tents to hire",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
      hookup: true,
  ...
  {
    slug: "kings-down-tail",
    name: "Kings Down Tail Caravan & Camping Park",
    kind: "stay",
    // The EX10 0PD postcode centroid, which the owner gives. OSM maps no
    // camp_site under this name; the nearest tagged site is Oakdown, 450 m
    // south-west, so the position is the postcode's rather than the entrance's.
    lat: 50.70868, lon: -3.17720,
    address: "Salcombe Regis, Sidmouth, Devon, EX10 0PD",
    phone: "01297 680313",
    email: "info@kingsdowntail.co.uk",
    url: "https://www.kingsdowntail.co.uk/site-facilities/",
    // The owner's own facilities page. It publishes no tariff and no dog rules;
    // both are behind the booking pages.
    notes: "Family-run park on the A3052 at Salcombe Regis, once part of a royal hunting ground, run by Vicki and David Paget, who live on site. Pitches for tents, caravans and motorhomes, grass and hardstanding, with and without electric, plus timber glamping pods for two or five. Heated toilet and shower block, unisex shower rooms, a family bathroom and a disabled wet room; shop, café, games field for rounders and cricket, a mile-long nature walk and a dog walk. Pizza on Fridays and a cooked breakfast on Saturdays. Easy access from the main road for a long vehicle. AA five pennants and Visit England five stars",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: null,
      dogs_note: "The park has its own dog walk and directories say dogs are welcome on a lead; the owner publishes no policy and no charge",
      // The owner's own dates: "Opening months 15th March - 15th November".
      season: { from: "03-15", to: "11-15" },
      price_per_night: null,
      price_note: "shown only in the online booking",
      hookup: true,
  ...
  {
    slug: "berry-barton",
    name: "Berry Barton Caravan & Camping Park",
    kind: "stay",
    // Centre of OSM way 33178582, "Berry Barton Caravan & Camping Park". The
    // EX12 3BD postcode centroid, which the owner gives, is 97 m north.
    lat: 50.69190, lon: -3.15585,
    address: "Berry Hill, Branscombe, Seaton, Devon, EX12 3BD",
    phone: "01297 680208",
    email: "info@berrybarton.com",
    url: "https://berrybarton.co.uk/camping/",
    // The owner's own camping and tariff pages. Note the site is berrybarton
    // .co.uk but the email address is at berrybarton.com, which still resolves
    // to an older version of the same park's site.
    notes: "Camping on a 350-acre working dairy farm on the hill above Branscombe, inside the Iron Age ramparts of Berry Camp, with the coast path a field away down the combe. Tents, motorhomes, campervans and caravans; touring vans should book ahead. Rates are for four people, extra adults £5. Hookups may not be used to charge an electric car. Out-of-season breaks are £150 for up to three nights",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "\"Dogs are welcome free of charge at Berry Barton but we ask that they are kept on leads whilst on the campsite and whilst they are in the vicinity of livestock.\" It is a dairy farm, so that matters. The stricter rules the tariff sets out — one dog only, off the furniture, never left alone — apply to the hire caravans",
      // The owner's 2026 tariff runs 14 March to 14 November.
      season: { from: "03-14", to: "11-14" },
      price_per_night: 18,
      price_note: "a camping pitch for four; £25 with electric hookup, so the hookup is £7",
      hookup: true,
    },
  },
  {
    slug: "branscombe-campsite",
    name: "Branscombe Campsite",
    kind: "stay",
    // The EX12 3BL postcode centroid, which the owner gives. OSM maps the
    // airfield the site sits on — way 264321126, "Branscombe Airfield" — but
    // not the campsite, and the aerodrome's centre is 700 m south-east, so
    // treat this position as the postcode's, not the gate's.
    lat: 50.70177, lon: -3.16605,
    address: "Branscombe, Devon, EX12 3BL",
    phone: "01297 680259",
    email: "info@branscombecampsite.com",
    url: "https://www.branscombecampsite.com/our-campsite/",
    // The owner's own site for prices and rules. It doesn't state its season;
    // directories say all year, which would make it the only one near
    // Branscombe that is.
    notes: "Small family site on Branscombe Airfield, at the top of the long village, with a grass airstrip alongside it and vintage aircraft in the hangars — a Stearman and a Zlín among them. Extra-large pitches, powered or not; powered ones are chosen when booking, the rest are find-your-own-spot. Hookups are 6 A, about 1200 watts, so camping kit only and nothing domestic. Shop, free showers, utility room with freezer, washing machine and tumble dryer, chemical disposal, games room, dog exercise area, limited wifi, and a playground for the under-sevens. Generators are banned on non-powered pitches",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "\"Yes, we encourage dogs as long as they are not listed under the dangerous dogs act.\" £2 a dog a night, with an exercise area; a dog may not be left in the van if you leave the site",
      season: null,
      price_per_night: 19,
      price_note: "a non-powered pitch for two in low season, £23 in high; a premium pitch £21 and £25, electric hookup £10, one person camping £15. Extra adult £6, child 5–15 £3, extra vehicle £5",
      hookup: true,
    },
  },
  {
    slug: "masons-arms-branscombe",
    name: "Mason's Arms",
    kind: "stay",
    food: { type: "pub" },
    // Centre of OSM way 894389850, "Mason's Arms". The EX12 3DJ postcode
    // centroid, which the owner gives, is 25 m south-west.
    lat: 50.69389, lon: -3.12938,
    address: "Branscombe, Seaton, Devon, EX12 3DJ",
    phone: "01297 680300",
    url: "https://www.masonsarms.co.uk/our-rooms/",
    // The owner's own rooms page, a St Austell Brewery house. It publishes no
    // dog charge, only that one applies.
    notes: "Fourteenth-century thatched inn in the middle of Branscombe, ten minutes up the lane from Branscombe Mouth where the path comes off the beach. Twenty-eight rooms in five grades — cosy double, standard double, accessible double, standard family, and the Branscombe rooms — with breakfast and VAT in the rate. Free parking next to the inn, first come first served, with a space held for the accessible room. Breakfast 8 to 10.30am, from the menu or a continental spread. Check in 4pm, out 11am. Two nights minimum on peak Fridays and Saturdays and over Christmas and New Year. No EV charging nearer than Sidmouth or Seaton",
    verified: "2026-09-16",
    stay: {
      type: "inn",
      dogs: true,
      dogs_note: "\"Dogs are permitted in most areas of the hotel, other than the main restaurant\", on a lead in public rooms and never left alone in a bedroom. A charge applies, unpublished, and brings a tennis ball, Forthglade treats, biodegradable poo bags and a beer for you",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking; the rate includes breakfast",
    },
  },
  {
    slug: "beer-head-caravan-park",
    name: "Beer Head Caravan Park",
    kind: "stay",
    // Centre of OSM way 51683443, "Beer Head Caravan Park". The EX12 3AH
    // postcode centroid, which the owner gives, is 180 m north-west.
    lat: 50.69227, lon: -3.09723,
    address: "Common Lane, Beer, Devon, EX12 3AH",
    phone: "01297 21107",
    url: "https://www.beer-head.com/camping",
    // The owner's own camping and tariff pages. The 2026 tariff is a
    // downloadable PDF and 2027 rates go online at the end of September.
    notes: "On the clifftop at Beer Head itself, the highest point of the day, with the path along the seaward edge of the park and Portland visible down the coast. Hardstanding pitches 9 m by 6 m with 16 A electric, water and chemical disposal for caravans and motorhomes; three touring pitches at Portland View, 5 m by 8 m, are hookup only. Tent pitches 8 m by 5 m, and the camping area is limited for size. Free hot showers, indoor washing station with washing-up liquid, freezer and microwave to use, Calor gas from reception. Arrive from midday, leave by 11am, no minimum stay. Ring for a same-day pitch",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "Up to four dogs, on a lead and never left alone, and no charge for them. The park has dog walking areas and the coast path fields, which matters here: dogs are off parts of Beer beach from 1 May to 30 September",
      season: null,
      price_per_night: null,
      price_note: "the 2026 tariff is a PDF download rather than a page. \"We do NOT charge for Electric, Dogs, Trailers, Gazebo's, Awnings, Showers, Extra People, BBQ's Extra Cars, Pup Tents or Wind Breakers.\" £30 non-refundable deposit, balance seven days before arrival",
      hookup: true,
    },
  },
  {
    ...
    name: "YHA Beer",
    kind: "stay",
    // Centre of OSM way 366952932, "YHA Beer". The EX12 3LL postcode centroid,
    // which the YHA gives, is 60 m north-west.
    lat: 50.70151, lon: -3.10106,
    address: "Bovey Combe, Beer, Seaton, Devon, EX12 3LL",
    phone: "0345 371 9502",
    url: "https://www.yha.org.uk/hostel/yha-beer",
    // The YHA's own page. Recorded for the camping field rather than the
    // hostel: the building itself takes no dogs at all.
    notes: "Victorian house in its own grounds above Beer, a few minutes down into the village. Dormitory and private rooms, and a camping field with pitch-up places for your own tent alongside bell tents and cabins. Free parking for up to eight cars, one car a room and not guaranteed — nothing on the page suggests a motorhome would fit or be welcome",
    verified: "2026-09-16",
    stay: {
      type: "hostel",
      dogs: false,
      dogs_note: "\"Pets are not permitted at YHA Beer (including in vehicles), except in our Camping & Cabins accommodation or when hiring the whole hostel through YHA Exclusive Hire. Assistance dogs are welcome.\" So a dog means the camping field, not a room",
      season: null,
      price_per_night: null,
      price_note: "shown only once dates are entered",
      hookup: false,
    },
  },
  {
    slug: "anchor-inn-beer",
    name: "The Anchor Inn",
    kind: "stay",
    food: { type: "pub" },
    // OSM node 471711200, "The Anchor Inn". The EX12 3ET postcode centroid,
    // which the operator gives, is 12 m north.
    lat: 50.69708, lon: -3.09183,
    address: "Fore Street, Beer, Seaton, Devon, EX12 3ET",
    phone: "01297 20386",
    url: "https://www.greeneking.co.uk/pubs/devon/anchor-inn",
    // Greene King's own pub and dog-friendly pages. Neither says anything about
    // dogs in the bedrooms, which is why dogs is null rather than true.
    notes: "Greene King inn at the top of the slipway in Beer, where the path drops into the village, with a clifftop beer garden above the beach. Six double, twin and superior rooms, all with sea views, en-suite, wifi and a tea tray. Food 8am to 9pm — locally landed fish, pub classics, Sunday roasts from £14.45",
    verified: "2026-09-16",
    stay: {
      type: "inn",
      dogs: null,
      dogs_note: "\"Dogs are welcome in designated dog-friendly pubs and bar areas at the manager's discretion\", on a lead and off the furniture. That is the bar; Greene King publishes nothing about dogs in the bedrooms, and booking sites say only that dogs are taken on request, agreed with the pub beforehand",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
    },
  ...
  {
    slug: "dolphin-hotel-beer",
    name: "The Dolphin Hotel",
    kind: "stay",
    food: { type: "pub" },
    // Centre of OSM way 1419387635, "The Dolphin"; node 471711204 carries the
    // name 6 m north. The EX12 3EQ postcode centroid, which the operator gives,
    // is 35 m north-west.
    lat: 50.69802, lon: -3.09259,
    address: "Fore Street, Beer, Devon, EX12 3EQ",
    phone: "01297 301700",
    url: "https://www.hall-woodhouse.co.uk/pub/the-dolphin-hotel-beer/",
    // Hall & Woodhouse's own pub page for the dog-friendly bedrooms. The £10
    // and the two-dog limit are from the Beer village directory, not the
    // brewery, and the owner's own dolphinhotelbeer.co.uk was returning a
    // server error when checked.
    notes: "Hall & Woodhouse hotel on Fore Street, halfway down Beer towards the shingle, with twenty-three bedrooms, a restaurant, two public bars — the Port and Starboard lounges — and a function room. Doubles, twins and singles, en-suite",
    verified: "2026-09-16",
    stay: {
      type: "inn",
      dogs: true,
      dogs_note: "The brewery lists dog-friendly bedrooms, and dogs are welcome in the Port and Starboard lounges to eat and drink but not in the restaurant or function room. A village directory gives £10 a room and a maximum of two dogs, in allocated bedrooms; the brewery publishes no figure, so ask when booking",
      season: null,
      price_per_night: null,
      price_note: "shown only in the online booking",
    },
  ...
  {
    slug: "eyre-court-hotel",
    name: "Eyre Court Hotel",
    kind: "stay",
    food: { type: "pub" },
    // OSM node 471627894, "Eyre Court Hotel"; node 339504651 tags the same
    // building as a pub, with the EX12 2NY postcode. That centroid is 45 m
    // north-east.
    lat: 50.70467, lon: -3.07150,
    address: "Queen Street, Seaton, Devon, EX12 2NY",
    phone: "01297 21455",
    // OSM gives eyrecourthotel.co.uk, which no longer resolves; nothing of the
    // owner's could be found, so every fact here is a directory's.
    notes: "Small family-run hotel, bar and restaurant in the middle of Seaton, a couple of hundred yards from the seafront where the day ends, with eight bedrooms",
    verified: null,
    stay: {
      type: "inn",
      dogs: null,
      dogs_note: "Booking directories say dogs of any size are welcome in designated rooms at no charge, and in all areas of the hotel; there is no owner's site left to check it against",
      season: null,
      price_per_night: null,
      price_note: "not published",
    },
  ...
  {
    slug: "mariners-hotel-seaton",
    name: "The Mariners Hotel",
    kind: "stay",
    // OSM node 14030942002, "The Mariners Hotel". The EX12 2NP postcode
    // centroid, which the owner gives, is 13 m west.
    lat: 50.70377, lon: -3.06628,
    address: "East Walk, Seaton, Devon, EX12 2NP",
    phone: "01297 20560",
    email: "contact@marinershotelseaton.co.uk",
    url: "https://marinershotelseaton.co.uk/rooms",
    // The owner's own rooms page. It sets out the rooms and the breakfast but
    // publishes no tariff, no parking and no dog policy.
    notes: "Bed and breakfast on the Esplanade at Seaton, where the walk finishes, with six bedrooms and two self-catering apartments over the Mariners Bistro. Twins, king doubles and a family room for three, some looking out to sea and some to the rear, all en-suite with a tea tray, hairdryer, blackout curtains and a TV. Breakfast is included with a bedroom. The Beer View and Sea Escape apartments have balconies and sleep up to four",
    verified: "2026-09-16",
    stay: {
      type: "bnb",
      dogs: null,
  ...
  {
    slug: "manor-farm-caravan-site",
    name: "Manor Farm Caravan & Camping Site",
    kind: "stay",
    // Centre of OSM way 31622819, "Manor Farm Caravan Site". The EX12 2JA
    // postcode centroid, which the owner gives, is 390 m south — the site
    // covers a lot of ground, so the way's centre is the better position.
    lat: 50.71611, lon: -3.08277,
    address: "Seaton Down Hill, Seaton, Devon, EX12 2JA",
    phone: "01297 21524",
    email: "info@manorfarmcaravansite.com",
    url: "https://www.manorfarmcaravansite.com/",
    // The owner's own site. It publishes no tariff and no dog rules; the pitch
    // count differs between its own pages and directories, 13 against 15.
    notes: "Family-run farm site on the hill above Seaton, off the A3052 between Sidmouth and Lyme Regis, looking over Lyme Bay and the Axe valley — about half an hour's walk down into the town. Thirteen terraced touring pitches with electric hookup, hardstanding and grass for an awning, and around fifty tent pitches; over two hundred seasonal pitches besides. Two toilet blocks with hot showers, laundry, chemical disposal and a disabled toilet. Farm shop, enclosed playground, a pets corner with goats, pigs and ferrets, and a large field for dog exercising",
    verified: "2026-09-16",
    stay: {
      type: "campsite",
      dogs: true,
      dogs_note: "The owner's site offers \"a large field for dog exercising\" but sets out no rules and no charge",
      // The owner's own dates: open seven days a week, 15 March to 15 November.
      season: { from: "03-15", to: "11-15" },
      price_per_night: null,
      price_note: "shown only in the online booking",
      hookup: true,
