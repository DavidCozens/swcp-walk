...
export default [
  ...
  {
    slug: "hartland-quay-hotel",
    name: "Hartland Quay Hotel",
    kind: "stay",
    food: { type: "pub" },
    // Centre of OSM way 5882717. EX39 6DU covers Stoke as well.
    lat: 50.99476, lon: -4.53366,
    address: "Hartland Quay, Hartland, Bideford, EX39 6DU",
    phone: "01237 441218",
    url: "https://hartlandquayhotel.co.uk/stay/",
    notes: "Thirteen rooms, twelve en-suite, breakfast included, and a three-bedroom cottage sleeping seven let nightly B&B. Free parking for residents. The Wreckers' Retreat bar takes walk-ins; booking recommended",
    verified: "2026-09-13",
    stay: {
      type: "hotel",
      dogs: true,
      dogs_note: "Only in the cottage and the Wreckers' Retreat bar — not the hotel bedrooms or the breakfast room. Say so when booking",
      season: null,
      price_per_night: null,
    },
  },
  ...
  {
    slug: "anchor-inn-hartland",
    name: "The Anchor Inn",
    kind: "stay",
    food: { type: "pub" },
    // Centre of OSM way 175410556.
    lat: 50.99200, lon: -4.47964,
    address: "Fore Street, Hartland, Bideford, EX39 6BD",
    phone: "01237 441414",
    email: "info@anchorhartland.co.uk",
    url: "https://www.anchorhartland.co.uk/rooms",
    notes: "16th-century coaching inn in Hartland village; nine B&B rooms, all upstairs. Car park at the rear. Book by phone to avoid agency fees. Latest check-in 10:30pm. Lifts to and from the path between Hartland Quay and Clovelly with seven days' notice; packed lunches ordered the night before",
    verified: "2026-09-13",
    stay: {
      type: "inn",
      dogs: true,
      dogs_note: "Only in the Crow's Nest, a self-catering suite with its own entrance: £150 a night, minimum two nights, breakfast not included. Not stated for the B&B rooms",
      season: null,
      price_per_night: 85,
      price_note: "double, breakfast included, booked direct",
    },
  },
  {
