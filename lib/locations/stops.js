...
export default [
  ...
  },
  {
    ...
    // Section 33's research may already have a Fowey record here: if so, use its
    // slug in mevagissey-fowey-ferry's serves instead.
    slug: "fowey-whitehouse",
    name: "Fowey (Whitehouse Quay)",
    kind: "stop",
    lat: 50.33312, lon: -4.63766,
    address: "Whitehouse Quay, Fowey",
    notes: "Where the Mevagissey ferry lands in Fowey, May to early October: to Mevagissey at 10.50, 12.50, 14.50 and 16.50 in September. The Mevagissey Ferry's page says the Polruan ferry runs from Whitehouse Quay too. The 24 to Par and St Austell leaves from Fowey Main Car Park, uphill, hourly Mon–Sat, and the 24A every two hours on Sundays",
    verified: "2026-09-16",
  },
];
