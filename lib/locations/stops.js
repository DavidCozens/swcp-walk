...
export default [
  ...
  },
  {
    ...
    notes: "In the middle of Helston, where the Porthleven and Lizard buses meet. From Blue Anchor: the 2 to Porthleven, 10–12 minutes, and on by Praa Sands and Marazion to Penzance; the 34 by Culdrose, Poldhu Cove and Mullion to the Lizard, about an hour. Both hourly Mon–Sat and every two hours on Sundays. Buses into Helston stop opposite, at Seven Stars. The 3 to Falmouth, and National Express to London",
    verified: "2026-09-16",
  },
];
