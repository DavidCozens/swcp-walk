...
export default [
  ...
  },
  {
    ...
    notes: "In Pendeen village on the B3306, near the North Inn. The 4 to Morvah and Penzance, hourly Mon–Sat, 33 minutes; the 4A and 4B by St Just in the evenings and on Sundays; in the summer holidays the 7 along the coast road to Gurnard's Head, Zennor and St Ives. For St Ives out of the summer, change at Penzance",
    verified: "2026-09-15",
  },
  {
  ...
  },
  {
    ...
    notes: "By the railway station at the end of the main line. The 1 and 1A to Lamorna Turn, St Buryan, Sennen Cove, Porthcurno and Land's End from Stand B; the 6 to Newlyn and Mousehole from Stand A; the 347 to Lamorna from Stand F; the 17 to St Erth and St Ives",
    verified: "2026-09-15",
  },
];
