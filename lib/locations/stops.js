...
export default [
  ...
  // Section 41.
  {
    // OSM node 7352763796 "Kingswear" (railway=station), NaPTAN 940GZZPDKGW.
    // 80 m from the kingswear endpoint, and the passenger ferry's Kingswear
    // pontoon (node 961721548) is 50 m from its platform end.
    slug: "kingswear-station",
    name: "Kingswear station",
    kind: "stop",
    lat: 50.34888, lon: -3.57239,
    address: "The Square, Kingswear, Dartmouth, TQ6 0AA",
    notes: "The steam railway's southern terminus, beside the Lower Ferry slip where the section starts: trains to Paignton in 25 minutes, February to the end of October only, and nothing at all in January. No intermediate stops in 2026, so it is no use for Churston or Goodrington. The passenger ferry to Dartmouth Town Jetty lands at the pontoon alongside",
    verified: "2026-09-16",
  },
  {
    // NaPTAN 1100DEM55123 "Hillhead Nethway Cross", OSM node 2321998086, on the
    // B3205 where Broad Road comes up from Scabbacombe. The S-bound stop is
    // 1100DEM55124. Croftland Farm (1100DEM55121, node 11663238) is 300 m west
    // and Hillhead Caravan Club Site (1100DEM55125/55126) 700 m north-east.
    slug: "nethway-cross",
    name: "Nethway Cross",
    kind: "stop",
    lat: 50.36509, lon: -3.55145,
    address: "B3205, Hillhead, Brixham",
    notes: "A crossroads on the ridge road between Kingswear and Brixham, and the only bus stop within reach of the middle of the section: Broad Road runs down from here to the lane to Scabbacombe Sands, about two kilometres. The 18 to Brixham and the 120 to Paignton, hourly every day, both call. Nothing here but the road",
    verified: "2026-09-16",
  },
  {
    // NaPTAN 1100TOA10028 "Hillhead Brixham Cross" (S-bound), OSM node
    // 12750755703; the N-bound pair are 1100TOA10029 and 1190TOA10027, all
    // within 100 m. Penhill Lane, the road to Woodhuish and Man Sands, leaves
    // the A379 140 m south of the stop. 1.9 km from the route above Man Sands,
    // so it is a stop rather than an escape point — just outside the 1.5 km a
    // section looks for one.
    slug: "hillhead-brixham-cross",
    name: "Hillhead (Brixham Cross)",
    kind: "stop",
    lat: 50.37309, lon: -3.54377,
    address: "A379, Hillhead, Brixham",
    notes: "Where the Kingswear road meets the A379 above Brixham, and the one place between the two ends of the day with a bus. The 18 to Brixham and to Kingswear and the 120 to Paignton and to Kingswear, each hourly every day. Penhill Lane drops from here to Woodhuish and Man Sands, about two and a half kilometres to the beach. A caravan club site, a filling station and houses; no shop worth the walk",
    verified: "2026-09-16",
  },
  {
    // NaPTAN 1190TOA10135 "Churston Dartmouth Road" (SE-bound), OSM node
    // 5240927491, which OSM names "Churston Golf Club"; opposite
    // (1190TOA10134, node 5240927490) is 70 m. On the A3022 by the golf
    // course. Churston Village, 1 km east on New Road, is a different pair of
    // stops (1190TOA10129 / 10131) that the 120 does not use.
    slug: "churston",
    name: "Churston (Dartmouth Road)",
    kind: "stop",
    lat: 50.39734, lon: -3.55695,
    address: "Dartmouth Road, Churston Ferrers, Brixham",
    notes: "On the Paignton road above Brixham, where the Kingswear bus meets the main Torbay corridor: the 120 to Kingswear and to Paignton hourly every day, and the 12 to Brixham one way and Paignton, Torquay and Newton Abbot the other, every ten to fifteen minutes and through the night at weekends. The change for a train at Paignton",
    verified: "2026-09-16",
  },
  {
    // OSM way 25726185 (amenity=bus_station), NaPTAN 119G1; Stand 10, where the
    // 120 starts and finishes, is 1190TOZ00818. Paignton main line station is
    // 130 m east (OSM node 246663389, NaPTAN 9100PAIGNTN, CRS PGN). Too far
    // from either end of section 41 to show on its page; recorded so the routes
    // that end here can say where they go.
    slug: "paignton-bus-station",
    name: "Paignton bus station",
    kind: "stop",
    lat: 50.43462, lon: -3.56645,
    address: "Great Western Road, Paignton",
    notes: "Torbay's interchange, beside the main line station. Stand 10 for the 120 down the coast road to Churston, Hillhead and Kingswear, hourly every day; Stands 11 and 14 for the 12 to Brixham and to Torquay and Newton Abbot. Trains to Exeter and to Plymouth from the station next door",
    verified: "2026-09-16",
  },
  {
    // OSM node 3331091692 "Paignton Queens Park", NaPTAN 940GZZPDPGN, the steam
    // railway's own platform — not the main line station, which is 90 m north.
    slug: "paignton-queens-park",
    name: "Paignton Queen's Park station",
    kind: "stop",
    lat: 50.43398, lon: -3.56469,
    address: "Queens Park, Paignton, TQ4 6AF",
    notes: "The steam railway's Paignton terminus, on its own platform beside the main line station and a few minutes' walk from the bus station. Trains to Kingswear in 25 minutes in season",
    verified: "2026-09-16",
  },
  // Sections 42 and 43.
  {
    // NaPTAN 1190TOA10280 "Cary Parade" (OSM node 496818333); the pair are
    // 1190TOA10279 and 1190TOA56643, all within 30 m. On the harbourside road
    // between the Strand and the Pavilion, 160 m from the section 42 route at
    // 13.6 km and 440 m from the torquay-harbour escape at Beacon Quay.
    slug: "torquay-cary-parade",
    name: "Torquay (Cary Parade)",
    kind: "stop",
    lat: 50.46184, lon: -3.52629,
    address: "Cary Parade, Torquay",
    notes: "The middle of Torquay, on the harbour, and where every bus in the bay meets. The 12 to Paignton and Brixham one way and Torquay, Newton Abbot the other, every 12 minutes Mon–Sat and through the night at weekends; the 22 to Babbacombe and St Marychurch every 15 minutes; the 11 to Maidencombe, Teignmouth and Dawlish Warren, hourly every day. Change here for Brixham: no bus runs from Babbacombe to Brixham without one",
    verified: "2026-09-16",
  },
  {
    // OSM node 29272140 "Torquay" (railway=station), NaPTAN 9100TORQUAY, CRS
    // TQY, GWR category B. On the sea front at Torre Abbey Sands, 200 m from
    // the section 42 route at 12.2 km, and 1.3 km round the bay from the
    // torquay-harbour escape. 3.0 km from the babbacombe endpoint.
    slug: "torquay-station",
    name: "Torquay station",
    kind: "stop",
    lat: 50.46105, lon: -3.54303,
    address: "Rathmore Road, Torquay, TQ2 6NW",
    notes: "On the sea front behind Torre Abbey Sands, with the path along the promenade in front of it: trains to Newton Abbot, Teignmouth, Dawlish, Starcross and Exeter one way and Paignton the other, about half-hourly every day. The way to reach either of these sections with the van left elsewhere, and the way back from Starcross. Ticket office Mon–Sat 7.10am – 5pm, Sundays 9.40am – 5.10pm; step-free to one platform only. The Torre Abbey Sands bus stop 400 m away has the 12 and the 22",
    verified: "2026-09-16",
  },
  {
    // NaPTAN 1100DEA05997 "Cockwood Bridge" (NE-bound, OSM node 430114787);
    // the opposite stop is 1100DEB10233 (node 1410035447), 20 m away. On the
    // A379 where it crosses the mouth of Cockwood harbour, 60 m from the
    // section 43 route at 21.1 km and 950 m short of the starcross endpoint.
    slug: "cockwood",
    name: "Cockwood",
    kind: "stop",
    lat: 50.61857, lon: -3.44886,
    address: "A379, Cockwood, Exeter",
    notes: "The last bus stop before the ferry pier, on the bridge over Cockwood harbour where the path crosses it. The 2 to Dawlish, Teignmouth and Newton Abbot one way and Starcross and Exeter the other, every 30 minutes Mon–Sat and hourly on Sundays, until after midnight. Two pubs on the harbour, the Anchor Inn and the Ship. Too close to the finish to be worth an escape record of its own",
    verified: "2026-09-16",
  },
  ...
  // Section 44.
  {
    // NaPTAN 1100DEC10731 "Otterton Cross Tree" (OSM node 577538548) at
    // 50.66047, -3.29741; the village also has Otterton Green (1100DEC10729/30,
    // nodes 446096880 / 577203597) and Ottery Street (1100DEC10732, node
    // 11838276234). The record is placed at the Green, in the middle of the
    // village by the Kings Arms, which is 70 m away.
    slug: "otterton",
    name: "Otterton",
    kind: "stop",
    lat: 50.65967, lon: -3.30212,
    address: "Fore Street, Otterton, EX9 7HB",
    notes: "The only village on the inland road between Budleigh Salterton and Newton Poppleford, and the nearest bus to Ladram Bay: the lane from Otterton Cross Tree down to the cove is 1.2 km. The 157 hourly Mon–Sat and four times on Sundays, and the 358 once each way into Exeter. The Kings Arms is on the same street",
    verified: "2026-09-17",
  },
  {
    // NaPTAN 1100DEC10665 "War Memorial" (OSM node 436251263). The 157 and the
    // 9/9A both call here, which makes it the change between them.
    slug: "newton-poppleford",
    name: "Newton Poppleford (War Memorial)",
    kind: "stop",
    lat: 50.70011, lon: -3.29617,
    address: "High Street, Newton Poppleford, EX10 0EZ",
    notes: "On the A3052 five kilometres inland, where the 157 from Exmouth meets the 9 and 9A from Exeter. Nowhere near the path, and recorded only because it is the one place the two spines of these sections cross: the 9/9A run every 30 minutes through here Mon–Sat. In practice it is quicker to change at Sidmouth Triangle",
    verified: "2026-09-17",
  },
  {
    // OSM node 21278292 "Exmouth" (railway=station), NaPTAN 9100EXMOUTH, CRS
    // EXM. 770 m from the exmouth endpoint, at the top of the Parade next to
    // the bus stops.
    slug: "exmouth-station",
    name: "Exmouth station",
    kind: "stop",
    lat: 50.62159, lon: -3.41497,
    address: "Imperial Road, Exmouth, EX8 1DE",
    notes: "The end of the Avocet Line, at the top of the Parade and 800 m from the start of section 44, with the town's bus stops in the same square. Trains to Topsham, Exeter Central and Exeter St Davids about every 30 minutes every day, from before six in the morning until nearly midnight. The way to reach the start of this section with the van left elsewhere",
    verified: "2026-09-17",
  },
  {
    // OSM way 967568065 "Exeter Bus Station" (the stands are NaPTAN
    // 1100DEZ05402 to 1100DEZ05413). The 9, 9A and 57 all start here.
    slug: "exeter-bus-station",
    name: "Exeter bus station",
    kind: "stop",
    lat: 50.72603, lon: -3.52377,
    address: "Paris Street, Exeter, EX1 2JY",
    notes: "Where the East Devon buses begin: the 9 and 9A to Sidmouth, Seaton and Honiton, and the 57 to Topsham and Exmouth. Ten minutes' walk from Exeter Central station and about twenty-five from St Davids. Not near any part of the path, but it is the hinge of every journey to and from these two sections",
    verified: "2026-09-17",
  },
  {
    // OSM node 6013523209 "Exeter St Davids" (railway=station), NaPTAN
    // 9100EXETRSD, CRS EXD. Exeter Central (node 6013523210, 9100EXETERC, EXC)
    // is 900 m nearer the bus station and is where most Avocet Line journeys
    // are actually useful.
    slug: "exeter-st-davids",
    name: "Exeter St Davids station",
    kind: "stop",
    lat: 50.72922, lon: -3.54357,
    address: "Bonhay Road, Exeter, EX4 4NT",
    notes: "The main Exeter station, and the far end of the Avocet Line from Exmouth — about 31 minutes, every 30 minutes, seven days a week. For the bus station change at Exeter Central instead, three minutes short of St Davids and a ten-minute walk from the stands",
    verified: "2026-09-17",
  },

  // Section 45.
  {
    // NaPTAN 1100DEC10695 "Drake's Avenue" (OSM node 11491295070). The 9A and
    // the 899 both call at the Sidford stops; this is the one both are
    // registered for and it sits in the middle of the village.
    slug: "sidford",
    name: "Sidford",
    kind: "stop",
    lat: 50.70248, lon: -3.22943,
    address: "Sidford, Sidmouth, EX10 9QP",
    notes: "The village at the head of the Sid, 2.4 km inland of Sidmouth seafront, with a Spar, a pub and the buses to Seaton and Honiton. Both the 9A and the 899 stop here on the way out of Sidmouth, so it is the first place on either road where the two meet",
    verified: "2026-09-17",
  },
  {
    // NaPTAN 1100DEB10472 "Castle Cottage" (OSM node 10815411152) — 60 m from
    // the Masons Arms and the nearest stop to the coast. The other village stop
    // is Branscombe Village Hall, 1100DEB10473 (node 6525186011) at 50.69253,
    // -3.13698, half a kilometre further up the valley.
    slug: "branscombe-village",
    name: "Branscombe (Castle Cottage)",
    kind: "stop",
    lat: 50.69381, lon: -3.13020,
    address: "Branscombe, Seaton, EX12 3DJ",
    notes: "Outside the Masons Arms in the middle of Branscombe, 740 m up the valley from Branscombe Mouth and the only bus stop in the ten kilometres between Sidmouth and Beer. The 899 five times a day Mon–Fri, three on Saturdays, and nothing at all on Sundays. Karen's Cars, the one taxi based in the village, is the alternative",
    verified: "2026-09-17",
  },
  {
    // OSM node 313304402 "Colyford" (railway=tram_stop) on the Seaton Tramway.
    slug: "colyford",
    name: "Colyford tram station",
    kind: "stop",
    lat: 50.72875, lon: -3.05795,
    address: "Colyford, Colyton, EX24 6QJ",
    notes: "Halfway up the Seaton Tramway, on the edge of the village and by the road crossing. About 14 minutes from Seaton, trams every 20 minutes in season. The village has a pub and a shop; the 9A does not come this way, though the Colyton road buses pass through",
    verified: "2026-09-17",
  },
  {
    // OSM node 313304396 "Colyton Station" (railway=tram_stop), the tramway's
    // inland terminus.
    slug: "colyton",
    name: "Colyton tram station",
    kind: "stop",
    lat: 50.74186, lon: -3.06236,
    address: "Station Road, Colyton, EX24 6HA",
    notes: "The top of the Seaton Tramway, 27 minutes and £12.10 from Seaton, with the town a few minutes' walk beyond. Tea rooms at the station. A destination rather than a connection — there is no onward bus worth the wait",
    verified: "2026-09-17",
  },
];
