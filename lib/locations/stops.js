...
export default [
  ...
  },
  {
    ...
    notes: "By the railway station at the end of the main line. The 1 and 1A to Lamorna Turn, St Buryan, Sennen Cove, Porthcurno and Land's End from Stand B; the 6 to Newlyn and Mousehole from Stand A; the 347 to Lamorna from Stand F; the 17 to St Erth and St Ives; the 4 by Morvah to Pendeen and St Just, and the 4A direct to St Just. In the summer holidays the 7 and 7A round the coast by St Ives and Land's End",
    verified: "2026-09-15",
  },
];
