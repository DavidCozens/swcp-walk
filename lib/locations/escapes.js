...
export default [
  ...
  // Section 42.
  {
    // Pay car park, centre of OSM way 22889154.
    slug: "broadsands",
    name: "Broadsands",
    kind: "escape",
    lat: 50.40474, lon: -3.55418,
    address: "Broadsands, Paignton",
    escape: {
      detail: "Pay car park behind the beach below the viaduct, with a beach café. No bus on the sea front: the 12 and the 120 call at Broadsands Dartmouth Road, about 700 m up Broadsands Road, the 12 every 12 to 15 minutes for Paignton and Brixham and the 120 hourly for Churston and Kingswear",
    },
    verified: null,
  },
  {
    // Pay car park, centre of OSM way 87563536.
    slug: "goodrington",
    name: "Goodrington Sands",
    kind: "escape",
    lat: 50.42437, lon: -3.56004,
    address: "Goodrington, Paignton",
    escape: {
      detail: "Seafront car parks behind the sands, with cafés, the water park and Goodrington station on the steam line — though no steam train stops there in 2026. The 12 and the 120 call at Goodrington YMCA, 270 m behind the beach: the 12 every 12 to 15 minutes to Paignton, Torquay and Brixham, the 120 hourly to Kingswear",
    },
    verified: null,
  },
  {
    // Torbay Council car park, centre of OSM way 22889811.
    slug: "paignton-harbour",
    name: "Paignton harbour",
    kind: "escape",
    lat: 50.43140, lon: -3.55624,
    address: "Paignton harbour, Paignton",
    escape: {
      detail: "Harbour car park in the middle of Paignton, a few minutes from the station and the buses. Paignton station is 700 m round the harbour: trains to Torquay, Teignmouth, Dawlish and Starcross, about half-hourly every day. The bus station next to it has the 12 to Brixham and Torquay every 12 minutes, the 22 to Babbacombe every 15, and the 120 down the coast road to Kingswear hourly",
    },
    verified: null,
  },
  {
    // Beacon Quay Car Park, centre of OSM way 22976290.
    slug: "torquay-harbour",
    name: "Torquay harbour",
    kind: "escape",
    lat: 50.45803, lon: -3.52468,
    address: "Beacon Quay, Torquay",
    escape: {
      detail: "Beacon Quay car park by the marina, in the middle of Torquay. Cary Parade, 440 m round the harbour, is where the bay's buses meet: the 12 to Paignton and Brixham every 12 minutes Mon–Sat and through the night at weekends, the 22 up to Babbacombe and St Marychurch every 15, the 11 hourly to Maidencombe, Teignmouth and Dawlish Warren. Torquay station, on the sea front at Torre Abbey Sands, is 1.3 km west",
    },
    verified: null,
  },
  {
    // Meadfoot Car Park, centre of OSM way 179455652.
    slug: "meadfoot",
    name: "Meadfoot Beach",
    kind: "escape",
    lat: 50.45732, lon: -3.51053,
    address: "Meadfoot Sea Road, Torquay",
    escape: {
      detail: "Free car park behind the beach east of Torquay, with a beach café. No bus reaches the beach: the nearest is Wellswood, about 750 m up Meadfoot Road, where the 11 and the 22 run into Torquay and up to Babbacombe",
    },
    verified: null,
  },
  {
    // Anstey's Cove Car Park, centre of OSM way 28963809.
    slug: "ansteys-cove",
    name: "Anstey's Cove",
    kind: "escape",
    lat: 50.47059, lon: -3.50220,
    address: "Anstey's Cove Road, Torquay",
    escape: {
      detail: "Pay car park above the cove, on the edge of Torquay. The 11 and the 22 call on Babbacombe Road 330 m up, four buses an hour on a weekday into Torquay one way and St Marychurch the other",
    },
    verified: null,
  },
  {
    // Pay car park, centre of OSM way 167067299.
    slug: "babbacombe-beach",
    name: "Babbacombe Beach",
    kind: "escape",
    lat: 50.47889, lon: -3.50959,
    address: "Beach Road, Babbacombe",
    escape: {
      detail: "Pay car park on the beach at the bottom of Beach Road, by the Cary Arms, with the cliff railway up to the Downs. Babbacombe Shops, at the top, is 300 m from the Downs and has the 11 and the 22 — into Torquay in about 20 minutes, or north to Teignmouth and Dawlish Warren on the 11",
    },
    verified: null,
  },
  // Section 43.
  {
    // Car park, centre of OSM way 33470308, operated by the Thatched Tavern.
    slug: "maidencombe",
    name: "Maidencombe",
    kind: "escape",
    lat: 50.50599, lon: -3.51506,
    address: "Maidencombe, Torquay",
    escape: {
      detail: "Pay car park at the Thatched Tavern, above the beach. The 11 calls at Maidencombe Cross, 370 m up the lane on the A379: hourly every day, Torquay and St Marychurch one way, Shaldon, Teignmouth and Dawlish the other. The only bus on this half of the section",
    },
    verified: null,
  },
  {
    // RSPB Labrador Bay, OSM node 5521005999.
    slug: "labrador-bay",
    name: "Labrador Bay",
    kind: "escape",
    lat: 50.52417, lon: -3.50948,
    address: "A379, Labrador Bay, Shaldon",
    escape: {
      detail: "RSPB car park on the Torquay road, with cirl buntings in the fields and a path down to the bay. The 11 calls at Lower Gabwell Deane Lane, 450 m north on the same road — the only stop within reach, hourly every day",
    },
    verified: null,
  },
  {
    // Ness Car Park, centre of OSM way 61158541.
    slug: "shaldon",
    name: "Shaldon",
    kind: "escape",
    lat: 50.53739, lon: -3.49997,
    address: "Ness Drive, Shaldon",
    escape: {
      detail: "Village at the mouth of the Teign, with the Ness car park, pubs and cafés, and the foot ferry to Teignmouth beside the bridge. The 11 calls at Shaldon Bridge Road, 790 m through the village, hourly every day for Teignmouth, Dawlish and Torquay; the 2 crosses the bridge but stops on the Teignmouth side",
    },
    verified: null,
  },
  {
    // Esplanade car park, centre of OSM way 560464585.
    slug: "teignmouth",
    name: "Teignmouth",
    kind: "escape",
    lat: 50.54662, lon: -3.49313,
    address: "The Esplanade, Teignmouth",
    escape: {
      detail: "Seafront car park by the pier, with the town, the station and the buses behind it. The Seaview Diner stop is 40 m away: the 2 every 30 minutes to Dawlish, Starcross and Exeter one way and Newton Abbot the other, running past midnight, and the 11 hourly to Shaldon, Maidencombe and Torquay. Teignmouth station is 200 m up, trains about half-hourly",
    },
    verified: null,
  },
  {
    // Dawlish Station Car Park, centre of OSM way 34344802.
    slug: "dawlish",
    name: "Dawlish",
    kind: "escape",
    lat: 50.58142, lon: -3.46357,
    address: "Station Road, Dawlish",
    escape: {
      detail: "The station is on the sea wall where the path runs, with the town and its shops just inland. Trains roughly half-hourly to Teignmouth and Torquay one way and Starcross and Exeter the other; ticket office Mon–Fri 7.05am – 7pm, Sat 7am – 2pm, closed Sundays. The 2 runs from The Green and Marine Garage every 30 minutes until after midnight, and the 11 hourly. If the sea wall line is shut, which storms do, the 2 takes rail tickets",
    },
    verified: null,
  },
  {
    // Car park, centre of OSM way 38162035.
    slug: "dawlish-warren",
    name: "Dawlish Warren",
    kind: "escape",
    ...
    escape: {
      detail: "Car park by the station at the neck of the Warren, with the nature reserve, shops and cafés. Trains about hourly to Starcross, one stop, and to Dawlish, Teignmouth and Torquay. The 11 terminates at Beach Road, 140 m away, hourly every day to Teignmouth and Torquay; the 2 does not come here, running inland by Cofton instead, and the only other bus is one midday community round trip. The path has 4.3 km still to run to the ferry pier from here",
    },
    verified: null,
  },
  // Section 44.
  {
    // Foxholes Long Stay, centre of OSM way 73235383, East Devon District Council.
    slug: "exmouth-seafront",
    name: "Exmouth seafront",
    kind: "escape",
    lat: 50.61108, lon: -3.39712,
    address: "Queen's Drive, Exmouth",
    escape: {
      detail: "Foxholes long-stay car park on the seafront, with cafés along the front and the town and station behind",
    },
    verified: null,
  },
  {
    // South Beach Store and café, centre of OSM way 106064996.
    slug: "sandy-bay",
    name: "Sandy Bay",
    kind: "escape",
    lat: 50.61049, lon: -3.36546,
    address: "Sandy Bay, Exmouth",
    escape: {
      detail: "The holiday park above the beach, with a shop and café on the path through it",
    },
    verified: null,
  },
  {
    // Lime Kiln car park, centre of OSM way 32484744.
    slug: "budleigh-salterton",
    name: "Budleigh Salterton",
    kind: "escape",
    lat: 50.63076, lon: -3.31232,
    address: "Lime Kiln, Budleigh Salterton",
    escape: {
      detail: "Lime Kiln car park at the mouth of the Otter, with the town's shops and cafés five minutes up the front",
    },
    verified: null,
  },
  {
    // Car park, centre of OSM way 165607385.
    slug: "ladram-bay",
    name: "Ladram Bay",
    kind: "escape",
    lat: 50.66056, lon: -3.28056,
    address: "Ladram Bay, Otterton",
    escape: {
      detail: "The holiday park in the cove between Otterton Point and High Peak, with a bar and restaurant on the path",
    },
    verified: null,
  },
  // Section 45.
  {
    // National Trust car park, centre of OSM way 180216232.
    slug: "salcombe-mouth",
    name: "Salcombe Hill",
    kind: "escape",
    lat: 50.68670, lon: -3.22020,
    address: "Salcombe Hill, Sidmouth",
    escape: {
      detail: "National Trust car park on the top of Salcombe Hill, the first road above Sidmouth",
    },
    verified: null,
  },
  {
    // Branscombe Mouth Car Park, centre of OSM way 51680009.
    slug: "branscombe-mouth",
    name: "Branscombe Mouth",
    kind: "escape",
    lat: 50.68837, lon: -3.12429,
    address: "Branscombe, Seaton",
    escape: {
      detail: "Pay car park behind the beach, with the Sea Shanty café; Branscombe village and its two pubs are up the valley",
    },
    verified: null,
  },
  {
    // The Dolphin, OSM node 471711204; Beer Village Stores is OSM node 471711207.
    slug: "beer",
    name: "Beer",
    kind: "escape",
    lat: 50.69807, lon: -3.09268,
    address: "Fore Street, Beer",
    escape: {
      detail: "Village at the foot of the cliffs, with pubs, a shop and cafés, and the beach where the path drops in",
    },
    verified: null,
  },
];
