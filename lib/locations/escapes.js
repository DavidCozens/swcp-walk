...
export default [
  ...
  },
  {
    ...
    escape: {
      detail: "Inland from Mullion Cove or Polurrian to the village, about 1.4 km from the cove car park: a Co-op and the post office by the stop, the Spar and the Old Inn at Churchtown, and buses from the Village Hall stop. The 34 to Poldhu Cove and Helston, about 40 minutes, and the other way to the Lizard, about 30; hourly Mon–Sat and every two hours on Sundays. For Porthleven change at Helston to the 2",
    },
    verified: "2026-09-16",
  },
  {
    ...
    escape: {
      detail: "Inland by the lane to the village green: pubs, cafés, shops and toilets, and the only bus, from The Green. The 34 to Mullion, about 30 minutes, and Helston, about an hour; hourly Mon–Sat and every two hours on Sundays. For Porthleven change at Helston to the 2",
    },
    verified: "2026-09-16",
  },
];
