...
export default [
  ...
  },
  {
    ...
    // lowest not tagged tidal, where section 17 crosses. Below it the Penpol
    // footbridge (way 106536340), the official line, is tidal, passable about
    // 3–4 hours either side of low water, and the Fern Pit ferry runs late May
    // to September, so neither makes the far bank near. The last three points are
    // drawn by hand between the coastline of Pentire Point East (way
