...
export default [
  ...
  },  // Sections 37 and 38.
  {
    ...
    phone: "01548 560897",
    email: "info@banthamestate.co.uk",
    notes: "Bantham Estate Ltd, Bantham, Kingsbridge, TQ7 3AN. The estate owns the village, the beach and the car park, and runs the seasonal passenger ferry over the Avon to Cockleridge Ham. Nothing on the page about dogs, bicycles or a child fare",
    verified: "2026-09-16",
  },
  {
    // Not an operator in the usual sense: Devon County Council contracts local
    // private hire firms to run the Fare Cars, and its own page is the only
    // published source. The 2023 F7 leaflet names Ivy Cabs of Ivybridge
    // (01752 895555); no operator is named for the F17.
    slug: "devon-fare-car",
    name: "Devon County Council (Fare Car)",
    kind: "operator",
    url: "https://www.traveldevon.info/bus/fare-car/",
    phone: "0345 155 1015",
    email: "devonbus@devon.gov.uk",
    notes: "\"A shared public transport service operated by Private Hire cars\" — passengers book and pay separately but share advertised timetabled journeys. Open to anyone of any age, resident or not. Book with the taxi company running the service, normally 24 hours ahead. Fares are \"slightly above the normal bus fare for the distance travelled\". Five schemes run in Devon; F7 and F17 both serve Bigbury-on-Sea and Challaborough",
    verified: "2026-09-16",
  },
  {
    slug: "totally-taxis-salcombe",
    name: "Totally Taxis",
    kind: "transfer",
    services: ["passenger"],
    // The site gives no address, only "Totally Taxis of Salcombe", so the
    // position is OSM's Salcombe place node 27198595. 12 km reaches Salcombe
    // (0.5 km) and Bigbury-on-Sea (9.8 km) — both named on the site — and stops
    // well short of the Yealm (21.4 km).
    covers: { lat: 50.23882, lon: -3.77261, radiusKm: 12 },
    dogs: null,
    hours: "Phone lines 9am – 11.30pm most days; other times by pre-booking",
    url: "https://www.totallytaxis.co.uk/",
    phone: "07542 626545",
    email: "totallytaxis@gmail.com",
    notes: "Salcombe. Names Salcombe, Kingsbridge, Malborough, Hope Cove, Thurlestone, South Milton, Bantham and Bigbury among the places it works, and has pages for the Oyster Shack at Bigbury and the Burgh Island Hotel — the only firm found that names both ends of section 38. Established 2009. Airport and Totnes station runs. Nothing on walkers, luggage capacity or dogs",
    verified: "2026-09-16",
  },
  {
    slug: "taxis-247-kingsbridge",
    name: "24/7 Taxis Kingsbridge & Salcombe",
    kind: "transfer",
    services: ["passenger"],
    // No site of its own, so no address to geocode: the position is OSM's
    // Kingsbridge place node 27198593. 10 km reaches Bigbury-on-Sea (8.1 km)
    // and Salcombe (5.5 km), not the Yealm (19.6 km).
    covers: { lat: 50.28486, lon: -3.77897, radiusKm: 10 },
    dogs: null,
    hours: "24 hours, on directory listings",
    url: null,
    phone: "01548 800800",
    notes: "Kingsbridge. Listed as covering Kingsbridge, Salcombe, Modbury, Totnes and Dartmouth. Mobile 07946 322824. Only on directory listings and a Facebook page, with no site of its own; Companies House shows 24/7 TAXI KINGSBRIDGE & SALCOMBE LTD (11540388) as active but with an active proposal to strike off, so ring to check it is still trading",
    verified: null,
  },
  {
    slug: "modbury-private-hire",
    name: "Modbury Private Hire Taxi",
    kind: "transfer",
    services: ["passenger"],
    // Position is OSM's Modbury place node 6580314252; the firm gives no
    // address. 10 km reaches Bigbury-on-Sea (7.4 km) and not Salcombe (15.3 km)
    // or the Yealm (12.3 km).
    covers: { lat: 50.34952, lon: -3.88818, radiusKm: 10 },
    dogs: null,
    url: null,
    phone: "07455 393693",
    notes: "Modbury, the nearest firm to the lanes behind Bigbury. Two Mercedes estate cars, four passengers each, with room for cases; local journeys, station and airport runs. Its own domain, modburytaxi.com, currently returns a Wix \"ConnectYourDomain\" error, so there is no site to check the details against — the firm is on Facebook as Modburytaxi. Nothing on walkers or dogs",
    verified: null,
  },
  // Sections 39 and 40.
  // ── Crossing 38.5 ──
  {
    slug: "salcombe-ferry-company",
    name: "The Salcombe Ferry Company",
    kind: "operator",
    // No website of its own was found: no salcombeferry.co.uk, no Facebook
    // page, nothing linked from bustimes.org's operator page (national code
    // SWSF). The contact details are the firm's own entry in South Hams
    // District Council's tourism directory, southhams.com.
    url: null,
    phone: "07769 319375",
    notes: "Runs the year-round foot ferry between Salcombe and East Portlemouth, the only crossing of the estuary. Simon Shortman; the address given is Ferry Steps, Fore Street, Salcombe, TQ8 8JG. The Coleridge Bus's list of local ferries gives a second number, 01548 842061. No site of its own, so nothing here is confirmed by the operator",
    verified: null,
  },

  // ── Section 40, the Dartmouth end ──
  {
    slug: "south-hams-district-council-ferry",
    name: "South Hams District Council (Dartmouth Lower Ferry)",
    kind: "operator",
    url: "https://www.dartmouthlowerferry.co.uk/",
    phone: "01803 752342",
    notes: "The council runs the Lower Ferry, the tug-and-float crossing between Dartmouth and Kingswear that has worked since the 1700s and is the last of its kind in England. Live service status on its own home page, and a Facebook group for disruption. Wheelchair accessible, with crew to help",
    verified: "2026-09-16",
  },
  {
    slug: "dartmouth-higher-ferry",
    name: "Dartmouth Higher Ferry (DKFBC Ltd)",
    kind: "operator",
    url: "https://dkfb.co.uk/",
    phone: "01803 837163",
    notes: "The Dartmouth & Kingswear Floating Bridge Company, at Dart Marina, Sandquay, Dartmouth, TQ6 9PH. Runs the Higher Ferry, a chain ferry a kilometre upstream of the Lower Ferry, carrying the A379 across the Dart. The phone is an answerphone for account and card queries, answered within about 24 hours, not a live service line; the site shows live status",
    verified: "2026-09-16",
  },
  {
    slug: "dartmouth-steam-railway",
    name: "Dartmouth Steam Railway & River Boat Company",
    kind: "operator",
    url: "https://www.dartmouthrailriver.co.uk/",
    phone: "01803 555872",
    notes: "Dart Valley Railway's Paignton to Kingswear steam line and its river boats, including the Dartmouth – Kingswear passenger ferry, which is how foot passengers reach the trains. Also the Dartmouth to Totnes river cruise and the paddle steamer Kingswear Castle",
    verified: "2026-09-16",
  },
  {
    slug: "dartmouth-castle-ferry",
    name: "Dartmouth Castle Ferry",
    kind: "operator",
    url: "https://www.dartmouthcastleferry.co.uk/",
    phone: null,
    email: "ferryman@dartmouthcastleferry.co.uk",
    notes: "Julian and Mark, two traditional open launches between Dartmouth's South Embankment and Stumpy Steps below Dartmouth Castle. No phone number anywhere on the site — email only. The site's footer is dated 2021, though the fares on it are headed 2026",
    verified: "2026-09-16",
  },

  // ── Buses ──
  {
    slug: "country-bus-devon",
    name: "Country Bus",
    kind: "operator",
    url: "https://www.countrybusdevon.co.uk/",
    phone: "01626 833664",
    email: "info@countrybusdevon.co.uk",
    notes: "Alansway Coaches Ltd trading as Country Bus, at King Charles Business Park, Heathfield, Newton Abbot, TQ12 6UT. Calls itself the largest independent bus operator in Devon, 31 local services. Runs the Monday–Friday 93T between Slapton, Strete and Dartmouth; Tally Ho runs the Saturday one. Office 6.30am – 7pm Mon–Fri",
    verified: "2026-09-16",
  },
  {
    slug: "coleridge-bus",
    name: "Coleridge Bus",
    kind: "operator",
    // Registered charity 282151, The Pitt Stop, South Allington, Kingsbridge,
    // TQ7 2NB. The site carries no single office number: each day's route has
    // its own volunteer to book with, listed in the route records below. The
    // number here is Kingsbridge Information Centre, which the charity gives as
    // its contact and which Devon County Council's own service directory
    // repeats.
    url: "https://www.coleridgebus.co.uk/",
    phone: "01548 853195",
    notes: "A volunteer-run community bus that has brought ten rural parishes into Kingsbridge since 1978, a different route each morning Tuesday to Friday, back at lunchtime. Sixteen seats, open to anyone, and the only public transport that reaches East Prawle, Beesands or North Hallsands at all. It holds a full bus operator's licence rather than running as a ring-and-ride. Booking is with a named volunteer for each day, before 8pm the evening before; bikes need booking too. General contact is Kingsbridge Information Centre, The Quay, Kingsbridge, TQ7 1HS. The website's copyright line reads 2012 and it says plainly that its times \"are for guidance only and are not time-tabled\", so ring before planning a day around it",
    verified: null,
  },

  // ── Taxis ──
  {
    slug: "prestige-taxis-dartmouth",
    name: "Prestige Taxis Dartmouth",
    kind: "transfer",
    services: ["passenger"],
    // No street address anywhere on the site, so the position is OSM's
    // Dartmouth place node 27199086. 20 km reaches Torcross (10.7 km),
    // East Portlemouth and Salcombe (18.2 km), all of which it names.
    covers: { lat: 50.35148, lon: -3.58384, radiusKm: 20 },
    dogs: null,
    hours: "6am – 11pm, every day",
    url: "https://yourtaxicab.co.uk/",
    phone: "01803 714336",
    notes: "Dartmouth. Names Dartmouth, Kingswear, Stoke Fleming, Strete, Slapton, Torcross, Stokenham, Chillington, Frogmore, East Prawle, East Portlemouth, Salcombe, Kingsbridge and Totnes station among the places it covers — the only firm found that names both ends of section 40 and most of section 39's escape points. A Mercedes CLA200 and an 8-seat minibus; a female driver on duty at all times; licensed by Great Western Railway for Totnes station runs. Sister firm to Roadrunner Taxis in Totnes. Nothing on walkers, luggage transfers or dogs",
    verified: "2026-09-16",
  },
  {
    slug: "merlins-taxi-slapton",
    name: "Merlin's Taxi",
    kind: "transfer",
    services: ["passenger"],
    // Based in Slapton; the firm gives no street address, so the position is
    // OSM's Slapton place node 29486599. 20 km reaches Torcross (3.0 km),
    // Dartmouth (8.4 km), Salcombe (10.0 km), Kingsbridge and Totnes, all named.
    covers: { lat: 50.29316, lon: -3.65651, radiusKm: 20 },
    dogs: true,
    dogs_note: "\"Allows dogs and other pets\", on the firm's own directory entry",
    url: "https://merlins-taxis.square.site/",
    phone: "07455 951185",
    email: "merlin.t.h@pm.me",
    notes: "The only taxi based on this stretch of coast, in Slapton itself: licensed hackney carriage 339, one four-passenger car, covering Salcombe, Dartmouth, Totnes, Kingsbridge and the villages between. Advance booking advised. Its own domain, merlinstaxi.co.uk, no longer resolves and the Square site it points to shows nothing but a title, so the details are from the firm's own entry in South Hams District Council's tourism directory. Nothing on walkers or luggage",
    verified: null,
  },
  {
    slug: "dw-cabs",
    ...
    kind: "transfer",
    services: ["passenger"],
    // "Totnes & South Hams", no street address on the site, so the position is
    // OSM's Totnes place node 27199310. 25 km reaches Dartmouth (12.1 km),
    // Kingsbridge (17.8 km), Torcross (18.6 km) and Salcombe (22.5 km), all of
    // which the firm names.
    covers: { lat: 50.43228, lon: -3.68715, radiusKm: 25 },
    dogs: null,
    hours: "Seven days a week; the site sends you to its Google listing for the hours",
    url: "https://dwcabs.co.uk/",
    phone: "07396 757738",
    notes: "Totnes and the South Hams. A licensed six-seat Ford Galaxy with room for luggage; pre-booked station meets timed to the train rather than the clock, airport runs, and South Hams journeys naming Dartmouth, Kingswear, Kingsbridge and Salcombe. WhatsApp on the same number, online booking form, card or cash. Nothing on coast path walkers, luggage transfers or dogs",
    verified: "2026-09-16",
  },
  // Section 41.
  {
    ...
    kind: "transfer",
    services: ["passenger"],
    // Unit 3, Trojan Industrial Estate, Borough Close, Paignton, TQ4 7EP, from
    // the firm's own site; position from postcodes.io. 10 km reaches Brixham
    // (6.3 km) and Kingswear (8.5 km); the firm names Brixham, Paignton and
    // Torquay.
    covers: { lat: 50.42390, lon: -3.59006, radiusKm: 10 },
    dogs: null,
    url: "http://waves.taxi/",
    phone: "01803 446688",
    email: "info@waves.taxi",
    notes: "Brixham, Paignton and Torquay, booked by app, online or phone. Saloons, estates, six-seaters and an eight-seat minibus; cash, card and contactless. On luggage the firm says only \"all luggage is dependent on size, please speak to our team so we can ensure we get the right vehicle to you\", which is the thing to do with two rucksacks. Nothing on dogs, walkers or hours anywhere on the site",
    verified: "2026-09-16",
  },
  {
    slug: "brixham-minibus-taxis",
    name: "Brixham Minibus Taxis (Premier Cars)",
    kind: "transfer",
    services: ["passenger"],
    // No address anywhere on the site, so the position is OSM's Brixham place
    // node 29486598. 10 km reaches Kingswear (6.7 km) as well as the Brixham
    // end of the day.
    covers: { lat: 50.39524, lon: -3.51454, radiusKm: 10 },
    dogs: null,
    url: "https://www.brixhamminibustaxis.com/",
    phone: "01803 857050",
    notes: "Brixham. Taxis and minibuses, trading as Premier Cars; all major cards taken, with a surcharge on card payments. The site is almost entirely airport transfers and gives no address, no hours and nothing on dogs, walkers or luggage; a directory entry adds Galmpton, Churston, Kingswear and Marldon to the area covered and calls it a 24-hour service, which the firm's own pages do not say. Ring before relying on either",
    verified: null,
  },
  {
    slug: "price-first-taxis",
    name: "Price First Taxis",
    kind: "transfer",
    services: ["passenger"],
    // No street address published, so the position is OSM's Paignton place node
    // 27199090. 15 km reaches Brixham (5.7 km), Kingswear (9.7 km) and Torquay,
    // which is the area the firm claims.
    covers: { lat: 50.43770, lon: -3.56327, radiusKm: 15 },
    dogs: null,
    hours: "24 hours, every day",
    url: "https://pricefirsttaxis.co.uk/taxis-brixham/",
    phone: "01803 322322",
    email: "bookings@pricefirsttaxis.com",
    notes: "Torquay, Paignton and Brixham, and the biggest firm in the bay: over a hundred vehicles, four, six and eight seaters, booked by phone, website or app, fixed prices quoted up front, cash, card or contactless. Trading since 2002. The one to ring when the last bus has gone. Nothing on dogs, walkers or luggage transfers, and no address published",
    verified: "2026-09-16",
  },
  // Sections 42 and 43.
  {
    slug: "starcross-exmouth-ferry",
    name: "Starcross Exmouth Ferry",
    kind: "operator",
    url: "https://starcrossexmouthferry.co.uk/",
    phone: "07934 461672",
    email: "starcrossferryco@outlook.com",
    // The site gives no company name beyond the trading name and no street
    // address beyond "Starcross, Exeter EX6 8HZ". Wikipedia attributes the
    // crossing to Exe to Sea Cruises; the operator's own pages say nothing of
    // the sort, so the trading name is what's recorded. A second mobile,
    // 07974 022536, is given for the Dawlish sea-front boat trips ("ring Mark").
    notes: "The one boat across the mouth of the Exe, April to the end of October. Cash only, on board — no cards and no advance booking. Phone answered 9am – 6pm. All boats MCA registered; every trip subject to weather and tide, and the day's times go on the operator's Facebook page rather than the website. Also does half-hour bay trips and a 1¼-hour coastal cruise from the Dawlish sea wall, and takes private hire for earlier and later crossings",
    verified: "2026-09-16",
  },
  {
    slug: "teignmouth-shaldon-ferry",
    name: "Teignmouth to Shaldon Ferry",
    kind: "operator",
    url: "https://teignmouthshaldonferry.co.uk/",
    // Phone from OSM node 277747145 "Shaldon Ferry Landing", which carries the
    // operator's own website tag.
    phone: "07896 711822",
    notes: "Calls itself Britain's oldest passenger ferry. Runs from the beach at both ends, on demand rather than to a timetable, every day of the year except Christmas Day and New Year's Day. Cash only. Day-to-day times and suspensions go on its Facebook page and by WhatsApp",
    verified: "2026-09-16",
  },
  {
    slug: "dawlish-community-transport",
    name: "Dawlish Community Transport",
    kind: "operator",
    url: "https://dawlish-mobility.co.uk/",
    phone: "01626 888890",
    // East Teignbridge Community Transport Association, Barton Hill Car Park,
    // Dawlish, EX7 9QH — behind the museum. Office 9am – 3pm.
    notes: "A volunteer charity behind the museum in Dawlish, mainly a ring-and-ride and Shopmobility service for people who can't use ordinary buses, but it also runs the registered 187 bus. Office 9am – 3pm. Ring before counting on it: nothing on its own site says the 187 is open to anyone, and the rest of what it does is not",
    verified: null,
  },

  // ── Taxis ──
  {
    slug: "babbacombe-cars",
    name: "Babbacombe Cars",
    kind: "transfer",
    services: ["passenger"],
    // 21 Petitor Road, Torquay, TQ1 4QD via postcodes.io — 130 m from the
    // babbacombe endpoint, the closest firm to it by a long way. 12 km reaches
    // Brixham (9.9 km) as well as both ends of section 42's finish.
    covers: { lat: 50.48491, lon: -3.52296, radiusKm: 12 },
    dogs: null,
    url: "https://babbacombecars.co.uk/",
    phone: "01803 326450",
    // The firm's own site would not load on 16 September 2026 — its TLS
    // certificate has expired — so the address and number are from directory
    // entries that agree with each other, and nothing here is confirmed
    // against the firm. Hence verified: null. The trading name appears as both
    // "Babbacombe Cars" and "Babbacombe Cabs".
    notes: "In Petitor Road, two minutes from where section 42 finishes and section 43 starts. Executive and chauffeur work as well as ordinary taxi runs. The firm's own website would not load when this was checked, so the address, number and everything else here come from directories rather than from the firm: ring before relying on it. Nothing anywhere on hours, dogs, walkers or luggage",
    verified: null,
  },
  {
    slug: "torbay-taxis",
    ...
    kind: "transfer",
    services: ["passenger"],
    // 55 Belgrave Road, Torquay, TQ2 5HZ via postcodes.io. 12 km reaches
    // Babbacombe (2.2 km), Brixham (8.3 km) and Paignton.
    covers: { lat: 50.46851, lon: -3.53983, radiusKm: 12 },
    dogs: null,
    hours: "24 hours a day, 7 days a week, 365 days a year",
    url: "https://torbaytaxis.co.uk/",
    phone: "01803 211611",
    email: "mail@torbaytaxis.co.uk",
    notes: "Torbay Taxis Ltd, Belgrave Road in the middle of Torquay, and the round-the-clock firm at the Babbacombe end of the day. Private hire, so it must be pre-booked — it can't be flagged down. Executive, saloon and estate cars, six-seaters and eight-seat minibuses; cash, card, Apple Pay and Google Pay; booking by phone or online. Nothing on dogs, walkers or luggage transfers",
    verified: "2026-09-16",
  },
  {
    slug: "tq12-taxis",
    ...
    kind: "transfer",
    services: ["passenger"],
    // Minerva House, 2 Highweek Street, Newton Abbot, TQ12 1TQ via
    // postcodes.io. Based inland, so the radius has to be generous: 15 km
    // reaches the babbacombe endpoint (8.3 km), Teignmouth (8.7 km) and
    // Shaldon, all of which the firm names. Deliberately not 16 km, which
    // would reach Starcross — the firm names Dawlish but not Starcross.
    covers: { lat: 50.53062, lon: -3.61357, radiusKm: 15 },
    dogs: null,
    hours: "Sun–Thu 6am – midnight, Fri 6am – 2am, Sat 6am – 3am; airport runs and pre-booked long distance any hour",
    url: "https://tq12taxis.co.uk/",
    phone: "01626 355555",
    email: "info@tq12taxis.co.uk",
    notes: "Newton Abbot, and the firm that names the whole middle of section 43: Teignmouth, Shaldon, Bishopsteignton and Dawlish among two dozen towns, with \"a small surcharge\" on the outlying ones. Standard, executive and multi-seat vehicles; fixed prices quoted for common runs. It does not name Starcross. Nothing on dogs, walkers or luggage transfers",
    verified: "2026-09-16",
  },
  {
    slug: "teign-taxis",
    ...
    kind: "transfer",
    services: ["passenger"],
    // The firm publishes only the postcode EX7 9PJ, Dawlish; position from
    // postcodes.io. 10 km reaches Starcross (5.3 km), Dawlish Warren and
    // Teignmouth — the only firm found that is based near the Starcross end.
    covers: { lat: 50.58068, lon: -3.46468, radiusKm: 10 },
    dogs: null,
    url: "https://teigntaxis.co.uk/",
    phone: "01626 391000",
    notes: "Dawlish, and the nearest firm to where section 43 finishes: Starcross is five kilometres up the coast road. Drivers DBS checked and licensed by Teignbridge District Council; card, contactless, Apple and Google Pay taken in the car; WhatsApp booking on the same number. It meets trains at Dawlish station in normal business hours. No hours, no address beyond the postcode, and nothing on dogs, walkers or luggage transfers. Alan's Taxis of Dawlish is the other established local firm — 4 to 8 seats, 24 hours with six hours' notice — but its site publishes no phone number at all",
    verified: null,
  },

  // ── Sections 44 and 45: East Devon ──
  // AVMT's own site (avmtbustimes.wixsite.com) carries the phone, the email and
  // the sentence describing where they run. Its 899 timetable is posted as an
  // image dated 2-9-24, so the TIMES below come from the registered data on
  // bustimes.org, not from here — hence the route is verified: null and the
  // provider is verified.
  {
    slug: "axe-valley-mini-travel",
    name: "AVMT Buses (Axe Valley Mini Travel)",
    kind: "operator",
    url: "https://avmtbustimes.wixsite.com/mysite/service-899",
    phone: "01297 625959",
    email: "avmtbuses@gmail.com",
    notes: "The local operator in Seaton, Axminster, Beer, Colyton, Branscombe and Sidmouth, and the only bus of any kind that reaches Branscombe. Their own timetable page is a photograph of a leaflet dated 2 September 2024, so ring before relying on a printed time. Dog policy not stated anywhere on their site",
    verified: "2026-09-17",
  },

  // tram.co.uk — the operator's own site, for the phone, the address, the
  // running pattern, the fares and the dog rule.
  {
    slug: "seaton-tramway",
    name: "Seaton Tramway",
    kind: "operator",
    ...
    phone: "01297 20375",
    notes: "Narrow-gauge electric tramway up the Axe from Seaton to Colyford and Colyton, on the old railway. A day out rather than a bus, but it is a real way inland off the end of section 45. Dogs £2 a journey or £4 all day, not allowed upstairs and not allowed on Seaton Wetlands. Riverside Depot, Harbour Road, Seaton, EX12 2NQ",
    verified: "2026-09-17",
  },

  // Greenslades Tours run the single commuter journey each way on the 358. Named
  // only by bustimes.org; no operator page found for the service, so null.
  {
    slug: "greenslades-tours",
    name: "Greenslades Tours",
    kind: "operator",
    url: null,
    phone: null,
    notes: "Devon coach operator; runs the one commuter journey each way on the 358 between Otterton, Budleigh Salterton and Exeter",
    verified: null,
  },

  // ---- taxis and transfers ----

  // Karen's Cars, Branscombe. Read on the firm's own site. The one firm on
  // either of these sections that advertises coast path walkers and luggage,
  // and says its dog policy out loud. Base taken as the Branscombe Castle
  // Cottage stop by the Masons Arms; 20 km from there reaches Budleigh
  // Salterton (about 13 km) and Lyme Regis (about 14 km), which is exactly the
  // stretch they name, and stops short of Exmouth (about 21 km), which they
  // don't.
  {
    slug: "karens-cars-branscombe",
    name: "Karen's Cars",
    kind: "transfer",
    services: ["passenger", "baggage"],
    covers: { lat: 50.69381, lon: -3.13020, radiusKm: 20 },
    dogs: true,
    dogs_note: "Well behaved dogs welcome",
    hours: "Weekends included, Sundays too; weekday hours not stated",
    url: "https://karenscarsbranscombe.com/",
    phone: "07557 044580",
    notes: "Based in Branscombe, which is the point: it is the only vehicle of any kind based in the ten roadless kilometres of section 45. \"From my base in Branscombe I aim to link the Jurassic Coast from Budleigh Salterton to Lyme Regis.\" Walkers' luggage transfer offered; VW Sharan licensed for six with the seats folded down for bags",
    verified: "2026-09-17",
  },

  // Seaton Cabs — own site. Dog policy stated in their own words.
  {
    slug: "seaton-cabs",
    name: "Seaton Cabs",
    kind: "transfer",
    services: ["passenger"],
    covers: { lat: 50.70352, lon: -3.06160, radiusKm: 20 },
    dogs: true,
    dogs_note: "\"100% dog-friendly\"",
    hours: "24 hours, pre-booked",
    url: "https://www.seatoncabs.co.uk/",
    phone: "07494 046464",
    notes: "Seaton, Colyton, Axminster, Lyme Regis and Sidmouth; six-seaters. Twenty kilometres from Seaton covers Beer, Branscombe Mouth and Sidmouth. Walkers and luggage not mentioned",
    verified: "2026-09-17",
  },

  // Executive Taxi Services, Seaton — own site. Lists Beer by name.
  {
    slug: "executive-taxi-seaton",
    name: "Executive Taxi Services",
    kind: "transfer",
    services: ["passenger"],
    covers: { lat: 50.70352, lon: -3.06160, radiusKm: 18 },
    dogs: null,
    url: "https://www.executivetaxiservices.com/",
    phone: "07761 884222",
    email: "executivetaxiservices1@gmail.com",
    notes: "Seaton, Sidmouth, Lyme Regis, Uplyme, Beer, Colyford, Colyton, Rousdon and Axmouth. One VW Touran licensed for six, realistically four with luggage. No hours given and no dog policy stated",
    verified: "2026-09-17",
  },

  // Sid Valley Cars, Sidmouth — own site. Address not given on the site, so the
  // coverage centre is Sidmouth Triangle.
  {
    slug: "sid-valley-cars",
    name: "Sid Valley Cars",
    kind: "transfer",
    services: ["passenger", "baggage"],
    covers: { lat: 50.67958, lon: -3.24006, radiusKm: 15 },
    dogs: null,
    url: "https://www.sidvalleycars.co.uk/",
    phone: "01395 577633",
    notes: "One of the longest-established firms in Sidmouth. Estate cars with room for cases, and a wait-and-return service. Hours, address and dog policy are not on their site",
    verified: "2026-09-17",
  },

  // ED Taxis, Sidmouth — own site, with a street address.
  {
    slug: "ed-taxis-sidmouth",
    name: "ED Taxis",
    kind: "transfer",
    services: ["passenger"],
    covers: { lat: 50.68300, lon: -3.24000, radiusKm: 15 },
    dogs: null,
    hours: "Every day",
    url: "https://www.sidmouthtaxi.co.uk/",
    phone: "07500 034345",
    notes: "Church Street, Sidmouth, EX10 8LG. A one-man firm booked direct, four- and six-seaters, Sidmouth and East Devon. Dogs not mentioned",
    verified: "2026-09-17",
  },

  // River Cabs, Exmouth — own site, with the address and the villages listed.
  // They name Ladram Bay and Sandy Bay, which is why the radius is 20 km rather
  // than a town one: Ladram Bay is 15 km and Sidmouth 17 km from the base.
  {
    slug: "river-cabs-exmouth",
    name: "River Cabs",
    kind: "transfer",
    services: ["passenger"],
    covers: { lat: 50.63157, lon: -3.39390, radiusKm: 20 },
    dogs: null,
    url: "https://rivercabs.co.uk/",
    phone: "01395 222111",
    notes: "38 Birchwood Road, Exmouth, EX8 4LL; also 07598 479537. Licensed hackneys, up to four passengers. They name Budleigh Salterton, Sidmouth, Sandy Bay and Ladram Bay holiday parks, which is every road access on section 44. Hours and dog policy not stated. The base coordinates are the Birchwood Road postcode area, not a confirmed door",
    verified: "2026-09-17",
  },

  // Paul's Taxi, Exmouth — own site, mobiles only.
  {
    slug: "pauls-taxi-exmouth",
    name: "Paul's Taxi",
    kind: "transfer",
    services: ["passenger"],
    covers: { lat: 50.61684, lon: -3.42290, radiusKm: 12 },
    dogs: null,
    url: "https://www.exmouthtaxiservice.co.uk/",
    phone: "07792 910802",
    email: "paulclemy@hotmail.co.uk",
    notes: "Family firm in Exmouth; second mobile 07816 522098. Local and long-distance journeys. No hours, no vehicle size, no dog policy and no service area on the site beyond \"Exmouth, East Devon\"",
    verified: "2026-09-17",
  },

  // Budleigh Salterton has no taxi firm with a website of its own that I could
  // find. Tugs is carried here because Budleigh is otherwise a hole between
  // Exmouth and Sidmouth, but the number is from directory listings only
  // (Thomson Local / Scoot / appfordevon), so verified is null and the note
  // says so. Ring before counting on it.
  {
    slug: "tugs-taxis-budleigh",
    name: "Tugs Taxis",
    kind: "transfer",
    services: ["passenger"],
    covers: { lat: 50.63076, lon: -3.31232, radiusKm: 10 },
    dogs: null,
    url: null,
    phone: "01395 272737",
    notes: "The Coach House, East Budleigh. Listed in directories only — no website of their own was found, so neither the number nor that they are still trading has been confirmed. Two other Budleigh numbers turn up in the same directories and are equally unconfirmed: Budget Taxis 01395 443222 and Andrew Pelosi 01395 443122",
    verified: null,
  },
];
