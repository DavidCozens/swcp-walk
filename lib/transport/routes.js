...
export default [
  ...
  },
  {
    ...
    // goes through the par-station stop record. Fowey Main Car Park (0800COD40767),
    // where it turns, is left for section 33. The 24S, schooldays only, isn't
    // entered. As entered it serves no escape point and St Austell is beyond reach
    // of Mevagissey, so it won't show on section 32; section 29's notes carry the
    // change. No buses 25–26 Dec or 1 Jan; bank holiday Monday 28 Dec runs Saturday
    // times.
    serves: ["st-austell-station", "par", "par-station"],
    season: null,
  ...
  },
  {
    ...
    // and the par-station stop record, as the 24. Fowey Main Car Park left for
    // section 33.
  ...
  },
  {
    ...
    // st-austell-station stop record; no other station on it is recorded yet (st-erth-station
    ...
    serves: ["par-station", "st-austell-station"],
    season: null,
