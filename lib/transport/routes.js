...
export default [
  ...
  },
  {
    ...
    // points only. Southbound it stops in Instow at Rectory Lane, Vespers and
    // Down Road; northbound at Marine Parade. Not at The Quay, which has no
    // services.
    serves: ["barnstaple-bus-station", "barnstaple-station", "fremington", "instow", "bideford-quay", "westward-ho"],
    season: null,
    ...
    notes: "Barnstaple bus station to Instow in about 25 minutes; Fremington is 10 minutes from Instow. Last bus from Barnstaple 23:25. No bus runs between Instow and Braunton: change at Barnstaple for the 21B, about an hour in all. Mon–Fri, 09:28 from Braunton SQ Restaurant reaches Instow Rectory Lane at 10:23 on the 10:00 21A; back, 09:48 from Instow Marine Parade reaches Braunton George Inn at 10:54. Northbound buses stop at Marine Parade, 300 m south of the quay",
    verified: "2026-09-13",
  },
  {
    slug: "service-21a",
    ...
    type: "bus",
    provider: "stagecoach-south-west",
    serves: ["barnstaple-bus-station", "barnstaple-station", "fremington", "instow", "bideford-quay", "appledore"],
    season: null,
    ...
    notes: "The 21's road as far as Bideford, then on to Appledore's Seagate Hotel stop, 200 m from the ferry slip. When the ferry isn't running, change at Bideford Quay for Instow",
    verified: "2026-09-13",
  },
  {
