...
export default [
  ...
  },
  {
    ...
    // Sep 2026, one page for the 2, 2A and 3, and bustimes.org. Long Rock goes
    // through the long-rock escape record: Mexico Inn (E-bound 0800COD40532, OSM
    // node 682271101, 270 m; opposite 0800COD40531, node 682271098, 340 m), every
    // journey both ways. Marazion: The Square (NW-bound 0800COD40548, OSM node
    // 682271152; E-bound 0800COD40549, node 682271155) is the
    // marazion-the-square stop record, where the route ends; the marazion endpoint
    // record goes through Cemetery (W-bound 0800COD40565, OSM node 682271192;
    // opposite 0800COD40564, node 682271190), 70 m, a timing point on Sundays and
    // on bustimes.org's all-stops list, and Turnpike Road (0800COA15684, OSM node
    // 9877709627; 0800COA15685), 350 m, the Mon–Sat timing point. Porthleven is
    // the porthleven endpoint through Harbour Bus Shelter (0800COD40636; opposite
    // 0800COD40637), 60 m by NaPTAN's position. Penzance is penzance-bus-station,
    // Stand E, and the penzance escape record. Mon–Sat the journeys on the hour
    // from Penzance go by Perranuthnoe to Helston, those at half past by
    // Goldsithney, Rosudgeon, Praa Sands, Ashton and Porthleven; Sundays every two
    // hours by Porthleven, and the hours between turn at Marazion Cemetery. The
    // 2A is an early journey to Mullion School and one in the afternoon. The 39A
    // (Camborne – Leedstown – Goldsithney – Marazion – Long Rock – Penzance, 5–6
    // a day Mon–Sat) and the 15 (Hayle – St Erth – Marazion – Long Rock –
